...
Events live in:
- `src/data/events.js` — base events (430+ inline) + imports all 97 modules into `EVENTS` export (~2,300+ total character events)
...
**Event coverage (~2,300+ total events across 98 modules):**
...
src/
  data/
    ...
    events.js                 — root event file, imports 97 modules, exports EVENTS array (~2,300+ total character events)
