...
103 countries, 231 world events, 225+ event modules (~3,700+ events), 1,314 registered flags, 314 ribbons. Last major work: PRs #90–92 — MODE A geographic expansion (Armenia/Azerbaijan, Australia, Baltic states, Bangladesh, Belarus, Brazil, Canada, Central Europe, Colombia, Cuba, Georgia, Germany/France, Greece/Portugal, India depth, Iran depth, Iraq, Italy, Japan, Laos, Namibia, Netherlands, North Korea, Panama/Peru/Colombia/Venezuela arcs, Philippines, Poland, Romania, Russia, Rwanda, Saudi Arabia, Singapore, South Africa, Spain, Taiwan/Malaysia, UK, Ukraine, USA, Uruguay/Paraguay/Ecuador); MODE B mechanics (leaningWeight system, desire_resolution arc); MODE C polish (year texture for 6 new condition IDs, 7 world-event orphaned flags). PR #93 MODE B: parent-of-ill-child arc (events_sick_child.js, 9 events); disabilityType initialization fix; year texture + identity card paths for sick child arc; 3 new ribbons. PR #94 MODE A: Cambodia depth arc (events_cambodia.js, 8 events — rural Year Zero, family taken, Phnom Penh return, perpetrator neighbor, second-generation silence, landmine landscape, Tuol Sleng, late reckoning); Swachh Bharat rural India event; Cochabamba Water War 2000 world event; 13 new flags + 8 Cambodia year-texture blocks. PR #95 MODE A: Jamaica (events_caribbean.js, 14 events — garrison childhood, Rasta worldview, 1980 election violence, emigration decision, area don, reggae generation, late reckoning + 2 follow-throughs); Trinidad and Tobago (5 events — Carnival, oil boom, ethnic politics, 1990 Muslimeen coup, steelband solidarity); Guinea (events_guinea.js, 13 events — 1958 No vote, French revenge, Sékou Touré apparatus, Camp Boiro, educated class exile, Conté coup morning, 2009 stadium massacre + 6 follow-throughs); Mongolia (events_mongolia.js, 12 events — nomadic childhood, 1937 purge, negdel collectivization, 1990 revolution, dissolution shock, dzud winter, Ulaanbaatar migration + 5 follow-throughs); 4 new countries added to countries.js. PR #96 MODE A: Eritrea arc (events_eritrea.js, 12 events — liberation childhood, independence 1993, border war 1998, indefinite national service, G-15 crackdown 2001, leaving decision, Sinai trafficking, diaspora tax, border war echo, national service reckoning, Sinai reckoning, late reckoning); Eritrea added to countries.js; 12 new flags + Eritrea year texture. MODE B: political leaning consequence arc (events_political_arc.js, 10 events — left under surveillance, dissident file known, left in 1980s rightward shift, nationalist in new nation, apolitical under pressure, centre accused from both sides, dissident outlasting regime+archive choice, right under communism, nationalist abroad, political conviction at midlife); 9 new political flags + year texture for pol_left_noted and pol_right_in_communist_state. MODE A depth: Ghana (3 events added to events_west_africa.js — Nkrumah school first-gen education, 1966 coup disillusionment, brain drain witness 2-choice); Korea (3 events added to events_korea.js — post-war poverty 1950s, Park Chung-hee development bargain 2-choice, DMZ separated family); 7 new flags + year texture for park_era_generation, dmz_separated_family, ghana_1966_disillusionment. MODE C: 7 new world events for Guinea (independence 1958, stadium massacre 2009), Mongolia (1990 revolution), Jamaica (independence 1962), Eritrea (independence 1993, border war 1998), Trinidad and Tobago (Muslimeen coup 1990); 3 new world-event flags. Flag audit: 1,314 registered, 0 orphaned. Run `npm run check-flags` to audit flag coverage.
