...
src/
  data/
    countries.js              — 102 countries with full demographic data (covers all major regions; recent adds: Armenia, Azerbaijan, Australia,
