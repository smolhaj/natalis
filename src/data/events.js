...
import { HISTORICAL_EVENTS } from './events/thematic/events_historical.js'
import { CULTURE_EVENTS } from './events/thematic/events_culture.js'
import { TECHNOLOGY_EVENTS } from './events/thematic/events_technology.js'
import { IMMIGRATION_EVENTS } from './events/thematic/events_immigration.js'
import { CAREER_REGIME_EVENTS } from './events/thematic/events_career_regime.js'
import { CONFLICT_CHILDHOOD_EVENTS } from './events/thematic/events_conflict_childhood.js'
import { LGBTQ_EVENTS } from './events/thematic/events_lgbtq.js'
import { MENTAL_HEALTH_EVENTS } from './events/thematic/events_mental_health.js'
import { GRIEF_EVENTS } from './events/thematic/events_grief.js'
import { GRIEF_MENTAL_EVENTS } from './events/thematic/events_grief_mental.js'
import { RELIGION_ARC_EVENTS } from './events/thematic/events_religion_arc.js'
import { LATE_LIFE_EVENTS } from './events/lifecycle/events_late_life.js'
import { CHILDREN_ARC_EVENTS } from './events/thematic/events_children_arc.js'
import { FAME_KARMA_EVENTS } from './events/thematic/events_fame_karma.js'
import { TEXTURE_EVENTS } from './events/thematic/events_texture.js'
import { SOCIETY_EVENTS } from './events/thematic/events_society.js'
import { CONSEQUENCE_EVENTS } from './events/thematic/events_consequence.js'
import { ROMANCE_ARC_EVENTS } from './events/thematic/events_romance_arc.js'
import { ACTIVITY_PAYOFF_EVENTS } from './events/thematic/events_activity_payoffs.js'
import { FRIEND_EVENTS } from './events/thematic/events_friends.js'
import { BUSINESS_EVENTS } from './events/thematic/events_business.js'
import { SIBLING_EVENTS } from './events/thematic/events_siblings.js'
import { EDUCATION_ARC_EVENTS } from './events/thematic/events_education_arc.js'
import { ADOLESCENCE_EVENTS } from './events/lifecycle/events_adolescence.js'
import { FERTILITY_EVENTS } from './events/lifecycle/events_fertility.js'
import { CAREER_WEALTH_EVENTS } from './events/thematic/events_career_wealth.js'
import { GULF_EAST_EVENTS } from './events/geographic/events_gulf_east.js'
import { RELATIONSHIP_QUALITY_EVENTS } from './events/thematic/events_relationship_quality.js'
import { DESIRES_EVENTS } from './events/lifecycle/events_desires.js'
import { SMALL_LIFE_EVENTS } from './events/lifecycle/events_small_life.js'
import { PLACES_EVENTS } from './events/thematic/events_places.js'
import { INFRASTRUCTURE_EVENTS } from './events/thematic/events_infrastructure.js'
import { CITY_EVENTS } from './events/thematic/events_cities.js'
import { DYING_CITY_EVENTS } from './events/thematic/events_dying_city.js'
import { CITIES_EXTENDED_EVENTS } from './events/thematic/events_cities_extended.js'
import { RURAL_TEXTURE_EVENTS } from './events/thematic/events_rural_texture.js'
import { POST_SOVIET_EVENTS } from './events/geographic/events_post_soviet.js'
import { VIETNAM_EVENTS } from './events/geographic/events_vietnam.js'
import { VIETNAM_DEPTH_EVENTS } from './events/geographic/events_vietnam_depth.js'
import { ILLNESS_EVENTS } from './events/thematic/events_illness.js'
import { PARENT_CARE_EVENTS } from './events/thematic/events_parent_care.js'
import { WEALTH_SYSTEM_EVENTS } from './events/thematic/events_wealth_system.js'
import { MONEY_EVENTS } from './events/thematic/events_money.js'
import { LATIN_AMERICA_EVENTS } from './events/geographic/events_latin_america.js'
import { MEXICO_DEPTH_EVENTS } from './events/geographic/events_mexico.js'
import { COUNTRY_ARC_EVENTS } from './events/geographic/events_country_arcs.js'
import { COUNTRY_ARC_2_EVENTS } from './events/geographic/events_country_arcs_2.js'
import { EARLY_LIFE_EVENTS } from './events/lifecycle/events_early_life.js'
import { EARLY_CHILDHOOD_2_EVENTS } from './events/lifecycle/events_early_childhood.js'
import { DECOLONISATION_EVENTS } from './events/geographic/events_decolonisation.js'
import { LABOR_EVENTS } from './events/thematic/events_labor.js'
import { ASIA_ARC_EVENTS } from './events/geographic/events_asia_arcs.js'
import { CROSSCUTTING_EVENTS } from './events/geographic/events_crosscutting.js'
import { DRC_EVENTS } from './events/geographic/events_drc.js'
import { INTERNET_ERA_EVENTS } from './events/thematic/events_internet_era.js'
import { ZIMBABWE_EVENTS } from './events/geographic/events_zimbabwe.js'
import { CLIMATE_EVENTS } from './events/thematic/events_climate.js'
import { INDIGENOUS_EVENTS } from './events/thematic/events_indigenous.js'
import { AUTOMATION_EVENTS } from './events/thematic/events_automation.js'
import { COUNTRY_ARC_3_EVENTS } from './events/geographic/events_country_arcs_3.js'
import { ARTS_EVENTS } from './events/thematic/events_arts.js'
import { INFORMAL_EVENTS } from './events/thematic/events_informal.js'
import { NEIGHBORHOOD_EVENTS } from './events/thematic/events_neighborhoods.js'
import { POSTRELEASE_EVENTS } from './events/thematic/events_postrelease.js'
import { MENTOR_EVENTS } from './events/thematic/events_mentor.js'
import { FAMILY_SILENCE_EVENTS } from './events/thematic/events_family_silence.js'
import { SOLO_LIFE_EVENTS } from './events/lifecycle/events_solo_life.js'
import { DYING_ARC_EVENTS } from './events/lifecycle/events_dying_arc.js'
import { BODY_ARC_EVENTS } from './events/lifecycle/events_body_arc.js'
import { GRANDPARENT_ARC_EVENTS } from './events/lifecycle/events_grandparent_arc.js'
import { EMPTY_NEST_EVENTS } from './events/lifecycle/events_empty_nest.js'
import { INHERITANCE_ARC_EVENTS } from './events/lifecycle/events_inheritance_arc.js'
import { COHERENCE_EVENTS } from './events/thematic/events_coherence.js'
import { ADOLESCENCE_2_EVENTS } from './events/lifecycle/events_adolescence_2.js'
import { POVERTY_EVENTS } from './events/thematic/events_poverty.js'
import { PREGNANCY_EVENTS } from './events/lifecycle/events_pregnancy.js'
import { MENOPAUSE_EVENTS } from './events/lifecycle/events_menopause.js'
import { CAREER_ARC_EVENTS } from './events/thematic/events_career_arcs.js'
import { CAREER_LONGEVITY_EVENTS } from './events/thematic/events_career_longevity.js'
import { SOCIAL_MEDIA_EVENTS } from './events/thematic/events_social_media.js'
import { SCANDINAVIA_EVENTS } from './events/geographic/events_scandinavia.js'
import { SCANDINAVIA_DEPTH_EVENTS } from './events/geographic/events_scandinavia_depth.js'
import { PALESTINE_EVENTS } from './events/geographic/events_palestine.js'
import { GANG_EVENTS } from './events/thematic/events_gang.js'
import { WORLD_RESPONSE_EVENTS } from './events/thematic/events_world_response.js'
import { SOCIAL_CAPITAL_EVENTS } from './events/thematic/events_social_capital.js'
import { CHILDHOOD_TEXTURE_EVENTS } from './events/lifecycle/events_childhood_texture.js'
import { EMIGRANT_INTEGRATION_EVENTS } from './events/thematic/events_emigrant_integration.js'
import { INTIMACY_EVENTS } from './events/thematic/events_intimacy.js'
import { SCHOOL_EVENTS } from './events/thematic/events_school.js'
import { CHILDREN_ABROAD_EVENTS } from './events/thematic/events_children_abroad.js'
import { STAYED_EVENTS } from './events/thematic/events_stayed.js'
import { SPORT_EVENTS } from './events/thematic/events_sport.js'
import { DISASTER_EVENTS } from './events/thematic/events_disasters.js'
import { ACTIVITY_CHOICE_EVENTS } from './events/thematic/events_activity_choice.js'
import { PROJECT_ARC_EVENTS } from './events/thematic/events_project_arc.js'
import { INDUSTRIAL_EVENTS } from './events/thematic/events_industrial.js'
import { LEBANON_EVENTS } from './events/geographic/events_lebanon.js'
import { CENTRAL_AMERICA_EVENTS } from './events/geographic/events_central_america.js'
import { CENTRAL_ASIA_EVENTS } from './events/geographic/events_central_asia.js'
import { UZBEKISTAN_EVENTS } from './events/geographic/events_uzbekistan.js'
import { KAZAKHSTAN_EVENTS } from './events/geographic/events_kazakhstan.js'
import { TAJIKISTAN_EVENTS } from './events/geographic/events_tajikistan.js'
import { KYRGYZSTAN_EVENTS } from './events/geographic/events_kyrgyzstan.js'
import { TURKMENISTAN_EVENTS } from './events/geographic/events_turkmenistan.js'
import { OFW_EVENTS } from './events/geographic/events_ofw.js'
import { ALGERIA_EVENTS } from './events/geographic/events_algeria.js'
import { KENYA_EVENTS } from './events/geographic/events_kenya.js'
import { KENYA_DEPTH_EVENTS } from './events/geographic/events_kenya_depth.js'
import { ETHIOPIA_EVENTS } from './events/geographic/events_ethiopia.js'
import { ETHIOPIA_DEPTH_EVENTS } from './events/geographic/events_ethiopia_depth.js'
import { CONDITION_ARC_EVENTS } from './events/thematic/events_condition_arc.js'
import { CONDITION_ARC_2_EVENTS } from './events/thematic/events_condition_arc_2.js'
import { INDONESIA_EVENTS } from './events/geographic/events_indonesia.js'
import { INDONESIA_DEPTH_EVENTS } from './events/geographic/events_indonesia_depth.js'
import { KURDISH_EVENTS } from './events/geographic/events_kurdish.js'
import { DEBT_EVENTS } from './events/thematic/events_debt.js'
import { HAITI_EVENTS } from './events/geographic/events_haiti.js'
import { DOMINICAN_REPUBLIC_EVENTS } from './events/geographic/events_dominican_republic.js'
import { SRI_LANKA_EVENTS } from './events/geographic/events_sri_lanka.js'
import { SRI_LANKA_DEPTH_EVENTS } from './events/geographic/events_sri_lanka_depth.js'
import { MOROCCO_EVENTS } from './events/geographic/events_morocco.js'
import { MOROCCO_DEPTH_EVENTS } from './events/geographic/events_morocco_depth.js'
import { ROHINGYA_EVENTS } from './events/geographic/events_rohingya.js'
import { TANZANIA_EVENTS } from './events/geographic/events_tanzania.js'
import { TANZANIA_DEPTH_EVENTS } from './events/geographic/events_tanzania_depth.js'
import { MULTILINGUAL_EVENTS } from './events/thematic/events_multilingual.js'
import { SENEGAL_EVENTS } from './events/geographic/events_senegal.js'
import { ADOPTEE_EVENTS } from './events/thematic/events_adoptee.js'
import { UYGHUR_EVENTS } from './events/geographic/events_uyghur.js'
import { PUERTO_RICO_EVENTS } from './events/geographic/events_puerto_rico.js'
import { SOLDIER_ARC_EVENTS } from './events/thematic/events_soldier_arc.js'
import { DOCUMENT_EVENTS } from './events/thematic/events_documents.js'
import { CLERGY_EVENTS } from './events/thematic/events_clergy.js'
import { SOUTHEAST_EUROPE_EVENTS } from './events/geographic/events_southeast_europe.js'
import { PAKISTAN_EVENTS } from './events/geographic/events_pakistan.js'
import { PAKISTAN_DEPTH_EVENTS } from './events/geographic/events_pakistan_depth.js'
import { EGYPT_EVENTS } from './events/geographic/events_egypt.js'
import { EGYPT_DEPTH_EVENTS } from './events/geographic/events_egypt_depth.js'
import { INDIA_EVENTS } from './events/geographic/events_india.js'
import { INDIA_DEPTH_EVENTS } from './events/geographic/events_india_depth.js'
import { IRELAND_TURKEY_EVENTS } from './events/geographic/events_ireland_turkey.js'
import { IRELAND_DEPTH_EVENTS } from './events/geographic/events_ireland_depth.js'
import { WEST_AFRICA_EVENTS } from './events/geographic/events_west_africa.js'
import { NIGERIA_EVENTS } from './events/geographic/events_nigeria.js'
import { NIGERIA_DEPTH_EVENTS } from './events/geographic/events_nigeria_depth.js'
import { GHANA_EVENTS } from './events/geographic/events_ghana.js'
import { UGANDA_EVENTS } from './events/geographic/events_uganda.js'
import { SOMALIA_EVENTS } from './events/geographic/events_somalia.js'
import { THAILAND_EVENTS } from './events/geographic/events_thailand.js'
import { THAILAND_DEPTH_EVENTS } from './events/geographic/events_thailand_depth.js'
import { NEPAL_EVENTS } from './events/geographic/events_nepal.js'
import { NEPAL_DEPTH_EVENTS } from './events/geographic/events_nepal_depth.js'
import { MYANMAR_EVENTS } from './events/geographic/events_myanmar.js'
import { MYANMAR_DEPTH_EVENTS } from './events/geographic/events_myanmar_depth.js'
import { TUNISIA_EVENTS } from './events/geographic/events_tunisia.js'
import { SUDAN_EVENTS } from './events/geographic/events_sudan.js'
import { ANGOLA_EVENTS } from './events/geographic/events_angola.js'
import { ANGOLA_DEPTH_EVENTS } from './events/geographic/events_angola_depth.js'
import { SUDAN_DEPTH_EVENTS } from './events/geographic/events_sudan_depth.js'
import { JORDAN_EVENTS } from './events/geographic/events_jordan.js'
import { LIBYA_EVENTS } from './events/geographic/events_libya.js'
import { LIBYA_DEPTH_EVENTS } from './events/geographic/events_libya_depth.js'
import { ZAMBIA_EVENTS } from './events/geographic/events_zambia.js'
import { ZAMBIA_DEPTH_EVENTS } from './events/geographic/events_zambia_depth.js'
import { MOZAMBIQUE_EVENTS } from './events/geographic/events_mozambique.js'
import { MOZAMBIQUE_DEPTH_EVENTS } from './events/geographic/events_mozambique_depth.js'
import { AFGHANISTAN_EVENTS } from './events/geographic/events_afghanistan.js'
import { AFGHANISTAN_DEPTH_EVENTS } from './events/geographic/events_afghanistan_depth.js'
import { YEMEN_EVENTS } from './events/geographic/events_yemen.js'
import { GIFTED_EVENTS } from './events/thematic/events_gifted.js'
import { GIFTED_2_EVENTS } from './events/thematic/events_gifted_2.js'
import { GIFTED_3_EVENTS } from './events/thematic/events_gifted_3.js'
import { CHINA_EVENTS } from './events/geographic/events_china.js'
import { KOREA_EVENTS } from './events/geographic/events_korea.js'
import { KOREA_DEPTH_EVENTS } from './events/geographic/events_korea_depth.js'
import { DISABILITY_EVENTS } from './events/thematic/events_disability.js'
import { ADDICTION_EVENTS } from './events/thematic/events_addiction.js'
import { CHILD_SOLDIER_EVENTS } from './events/thematic/events_child_soldier.js'
import { WWI_DEPRESSION_EVENTS } from './events/thematic/events_wwi_depression.js'
import { DIVORCE_EVENTS } from './events/thematic/events_divorce.js'
import { DEMENTIA_EVENTS } from './events/thematic/events_dementia.js'
import { CELEBRITY_EVENTS } from './events/thematic/events_celebrity.js'
import { TEACHER_ARC_EVENTS } from './events/thematic/events_teacher_arc.js'
import { WOUND_COPING_EVENTS } from './events/lifecycle/events_wound_coping.js'
import { PARTNER_WANTS_EVENTS } from './events/thematic/events_partner_wants.js'
import { RELATIONSHIP_CROSSOVER_EVENTS } from './events/thematic/events_relationship_crossover.js'
import { SYRIA_EVENTS } from './events/geographic/events_syria.js'
import { CHILD_DEATH_ARC_EVENTS } from './events/thematic/events_child_death_arc.js'
import { ISRAEL_EVENTS } from './events/geographic/events_israel.js'
import { PANDEMIC_EVENTS } from './events/thematic/events_pandemic.js'
import { GREECE_PORTUGAL_EVENTS } from './events/geographic/events_greece_portugal.js'
import { GREECE_DEPTH_EVENTS } from './events/geographic/events_greece_depth.js'
import { SPAIN_EVENTS } from './events/geographic/events_spain.js'
import { PHILIPPINES_EVENTS } from './events/geographic/events_philippines.js'
import { PHILIPPINES_DEPTH_EVENTS } from './events/geographic/events_philippines_depth.js'
import { UK_EVENTS } from './events/geographic/events_uk.js'
import { GERMANY_FRANCE_EVENTS } from './events/geographic/events_germany_france.js'
import { USA_EVENTS } from './events/geographic/events_usa.js'
import { AUSTRALIA_EVENTS } from './events/geographic/events_australia.js'
import { AUSTRALIA_DEPTH_EVENTS } from './events/geographic/events_australia_depth.js'
import { CANADA_EVENTS } from './events/geographic/events_canada.js'
import { CANADA_DEPTH_EVENTS } from './events/geographic/events_canada_depth.js'
import { ITALY_EVENTS } from './events/geographic/events_italy.js'
import { ITALY_DEPTH_EVENTS } from './events/geographic/events_italy_depth.js'
import { SPAIN_DEPTH_EVENTS } from './events/geographic/events_spain_depth.js'
import { POLAND_EVENTS } from './events/geographic/events_poland.js'
import { POLAND_DEPTH_EVENTS } from './events/geographic/events_poland_depth.js'
import { RUSSIA_EVENTS } from './events/geographic/events_russia.js'
import { RUSSIA_DEPTH_EVENTS } from './events/geographic/events_russia_depth.js'
import { UKRAINE_EVENTS } from './events/geographic/events_ukraine.js'
import { UKRAINE_DEPTH_EVENTS } from './events/geographic/events_ukraine_depth.js'
import { IRAN_DEPTH_EVENTS } from './events/geographic/events_iran_depth.js'
import { ARGENTINA_DEPTH_EVENTS } from './events/geographic/events_argentina_depth.js'
import { SOUTH_AFRICA_EVENTS } from './events/geographic/events_south_africa.js'
import { SOUTH_AFRICA_DEPTH_EVENTS } from './events/geographic/events_south_africa_depth.js'
import { ROMANIA_EVENTS } from './events/geographic/events_romania.js'
import { ROMANIA_DEPTH_EVENTS } from './events/geographic/events_romania_depth.js'
import { DESIRE_RESOLUTION_EVENTS } from './events/lifecycle/events_desire_resolution.js'
import { CENTRAL_EUROPE_EVENTS } from './events/geographic/events_central_europe.js'
import { CZECH_REPUBLIC_EVENTS } from './events/geographic/events_czech_republic.js'
import { SWEDEN_EVENTS } from './events/geographic/events_sweden.js'
import { NORWAY_EVENTS } from './events/geographic/events_norway.js'
import { DENMARK_EVENTS } from './events/geographic/events_denmark.js'
import { BALTIC_EVENTS } from './events/geographic/events_baltic.js'
import { GEORGIA_EVENTS } from './events/geographic/events_georgia.js'
import { TAIWAN_MALAYSIA_EVENTS } from './events/geographic/events_taiwan_malaysia.js'
import ARMENIA_AZ_EVENTS from './events/geographic/events_armenia_azerbaijan.js'
import BELARUS_EVENTS from './events/geographic/events_belarus.js'
import UY_PY_EC_EVENTS from './events/geographic/events_uy_py_ec.js'
import { ECUADOR_EVENTS } from './events/geographic/events_ecuador.js'
import { EL_SALVADOR_EVENTS } from './events/geographic/events_el_salvador.js'
import { GUATEMALA_EVENTS } from './events/geographic/events_guatemala.js'
import { HONDURAS_EVENTS } from './events/geographic/events_honduras.js'
import { NICARAGUA_EVENTS } from './events/geographic/events_nicaragua.js'
import NORTH_KOREA_EVENTS from './events/geographic/events_north_korea.js'
import { NORTH_KOREA_DEPTH_EVENTS } from './events/geographic/events_north_korea_depth.js'
import CUBA_EVENTS from './events/geographic/events_cuba.js'
import { CUBA_DEPTH_EVENTS } from './events/geographic/events_cuba_depth.js'
import NAMIBIA_EVENTS from './events/geographic/events_namibia.js'
import { NAMIBIA_DEPTH_EVENTS } from './events/geographic/events_namibia_depth.js'
import LAOS_EVENTS from './events/geographic/events_laos.js'
import { LAOS_DEPTH_EVENTS } from './events/geographic/events_laos_depth.js'
import SINGAPORE_EVENTS from './events/geographic/events_singapore.js'
import { SINGAPORE_DEPTH_EVENTS } from './events/geographic/events_singapore_depth.js'
import NETHERLANDS_EVENTS from './events/geographic/events_netherlands.js'
import { NETHERLANDS_DEPTH_EVENTS } from './events/geographic/events_netherlands_depth.js'
import { PORTUGAL_DEPTH_EVENTS } from './events/geographic/events_portugal_depth.js'
import BRAZIL_EVENTS from './events/geographic/events_brazil.js'
import { BRAZIL_DEPTH_EVENTS } from './events/geographic/events_brazil_depth.js'
import BANGLADESH_EVENTS from './events/geographic/events_bangladesh.js'
import { BANGLADESH_DEPTH_EVENTS } from './events/geographic/events_bangladesh_depth.js'
import IRAQ_EVENTS from './events/geographic/events_iraq.js'
import { IRAQ_DEPTH_EVENTS } from './events/geographic/events_iraq_depth.js'
import RWANDA_EVENTS from './events/geographic/events_rwanda.js'
import COLOMBIA_EVENTS from './events/geographic/events_colombia.js'
import { COLOMBIA_DEPTH_EVENTS } from './events/geographic/events_colombia_depth.js'
import VENEZUELA_EVENTS from './events/geographic/events_venezuela.js'
import { VENEZUELA_DEPTH_EVENTS } from './events/geographic/events_venezuela_depth.js'
import PERU_EVENTS from './events/geographic/events_peru.js'
...
import { TURKEY_EVENTS } from './events/geographic/events_turkey.js'
import { TURKEY_DEPTH_EVENTS } from './events/geographic/events_turkey_depth.js'
import { NOMADIC_EVENTS } from './events/geographic/events_nomadic.js'
...
import { GULF_ROUTE_EVENTS } from './events/geographic/events_gulf_route.js'
...
import { MENDE_EVENTS } from './events/geographic/events_mende.js'
...
import { ERITREA_EVENTS } from './events/geographic/events_eritrea.js'
import { BURKINA_EVENTS } from './events/geographic/events_burkina.js'
import { POLITICAL_ARC_EVENTS } from './events/thematic/events_political_arc.js'
import { BOLIVIA_EVENTS } from './events/geographic/events_bolivia.js'
import { BOLIVIA_DEPTH_EVENTS } from './events/geographic/events_bolivia_depth.js'
import { NEW_ZEALAND_EVENTS } from './events/geographic/events_new_zealand.js'
import { NEW_ZEALAND_DEPTH_EVENTS } from './events/geographic/events_new_zealand_depth.js'
import { SONDER_EVENTS } from './events/sonder/events_sonder.js'
import { AID_WORKER_EVENTS } from './events/thematic/events_aid_worker.js'
import { FIJI_EVENTS } from './events/geographic/events_fiji.js'
import { WATER_INFRA_EVENTS } from './events/thematic/events_water_infra.js'
import { BONDED_LABOR_EVENTS } from './events/thematic/events_bonded_labor.js'
import { SEX_WORK_EVENTS } from './events/thematic/events_sex_work.js'
import { CULT_EVENTS } from './events/thematic/events_cults.js'
import { FGM_EVENTS } from './events/thematic/events_fgm.js'
import { MALI_EVENTS } from './events/geographic/events_mali.js'
import { IVORY_COAST_EVENTS } from './events/geographic/events_ivory_coast.js'
import { IVORY_COAST_DEPTH_EVENTS } from './events/geographic/events_ivory_coast_depth.js'
import { CAMEROON_EVENTS } from './events/geographic/events_cameroon.js'
import { CAMEROON_DEPTH_EVENTS } from './events/geographic/events_cameroon_depth.js'
import { LOCAL_EVENTS } from './events/thematic/events_local.js'
import { EVENTS_2010S } from './events/thematic/events_2010s.js'
import { EVENTS_SONDER_2 } from './events/sonder/events_sonder_2.js'
import { EVENTS_SONDER_3 } from './events/sonder/events_sonder_3.js'
import { EVENTS_SONDER_4 } from './events/sonder/events_sonder_4.js'
import { EVENTS_SONDER_5 } from './events/sonder/events_sonder_5.js'
import { EVENTS_SONDER_6 } from './events/sonder/events_sonder_6.js'
import { EVENTS_SONDER_7 } from './events/sonder/events_sonder_7.js'
import { EVENTS_SONDER_8 } from './events/sonder/events_sonder_8.js'
import { EVENTS_SONDER_9 } from './events/sonder/events_sonder_9.js'
import { EVENTS_SONDER_10 } from './events/sonder/events_sonder_10.js'
import { EVENTS_SONDER_11 } from './events/sonder/events_sonder_11.js'
import { EVENTS_SONDER_12 } from './events/sonder/events_sonder_12.js'
import { EVENTS_SONDER_13 } from './events/sonder/events_sonder_13.js'
import { EVENTS_SONDER_14 } from './events/sonder/events_sonder_14.js'
import { EVENTS_SONDER_15 } from './events/sonder/events_sonder_15.js'
import { EVENTS_SONDER_16 } from './events/sonder/events_sonder_16.js'
import { EVENTS_SONDER_17 } from './events/sonder/events_sonder_17.js'
import { EVENTS_SONDER_18 } from './events/sonder/events_sonder_18.js'
import { EVENTS_SONDER_19 } from './events/sonder/events_sonder_19.js'
import { EVENTS_SONDER_20 } from './events/sonder/events_sonder_20.js'
import { EVENTS_SONDER_21 } from './events/sonder/events_sonder_21.js'
import { EVENTS_SONDER_22 } from './events/sonder/events_sonder_22.js'
import { EVENTS_SONDER_23 } from './events/sonder/events_sonder_23.js'
import { EVENTS_SONDER_24 } from './events/sonder/events_sonder_24.js'
import { EVENTS_SONDER_25 } from './events/sonder/events_sonder_25.js'
import { EVENTS_SONDER_26 } from './events/sonder/events_sonder_26.js'
import { EVENTS_SONDER_27 } from './events/sonder/events_sonder_27.js'
import { EVENTS_SONDER_28 } from './events/sonder/events_sonder_28.js'
import { EVENTS_SONDER_29 } from './events/sonder/events_sonder_29.js'
import { EVENTS_SONDER_30 } from './events/sonder/events_sonder_30.js'
import { EVENTS_SONDER_31 } from './events/sonder/events_sonder_31.js'
import { EVENTS_SONDER_32 } from './events/sonder/events_sonder_32.js'
import { EVENTS_SONDER_33 } from './events/sonder/events_sonder_33.js'
import { EVENTS_SONDER_34 } from './events/sonder/events_sonder_34.js'
import { EVENTS_SONDER_35 } from './events/sonder/events_sonder_35.js'
import { EVENTS_SONDER_36 } from './events/sonder/events_sonder_36.js'
import { EVENTS_SONDER_37 } from './events/sonder/events_sonder_37.js'
import { EVENTS_SONDER_38 } from './events/sonder/events_sonder_38.js'
import { EVENTS_SONDER_39 } from './events/sonder/events_sonder_39.js'
import { EVENTS_SONDER_40 } from './events/sonder/events_sonder_40.js'
import { EVENTS_SONDER_41 } from './events/sonder/events_sonder_41.js'
import { EVENTS_SONDER_42 } from './events/sonder/events_sonder_42.js'
import { EVENTS_SONDER_43 } from './events/sonder/events_sonder_43.js'
import { EVENTS_SONDER_44 } from './events/sonder/events_sonder_44.js'
import { EVENTS_SONDER_45 } from './events/sonder/events_sonder_45.js'
import { EVENTS_SONDER_46 } from './events/sonder/events_sonder_46.js'
import { EVENTS_SONDER_47 } from './events/sonder/events_sonder_47.js'
import { EVENTS_SONDER_48 } from './events/sonder/events_sonder_48.js'
import { EVENTS_SONDER_49 } from './events/sonder/events_sonder_49.js'
import { EVENTS_SONDER_50 } from './events/sonder/events_sonder_50.js'
import { EVENTS_SONDER_51 } from './events/sonder/events_sonder_51.js'
import { EVENTS_SONDER_52 } from './events/sonder/events_sonder_52.js'
import { EVENTS_SONDER_53 } from './events/sonder/events_sonder_53.js'
import { EVENTS_SONDER_54 } from './events/sonder/events_sonder_54.js'
import { EVENTS_SONDER_55 } from './events/sonder/events_sonder_55.js'
import { EVENTS_SONDER_56 } from './events/sonder/events_sonder_56.js'
import { EVENTS_SONDER_57 } from './events/sonder/events_sonder_57.js'
import { EVENTS_SONDER_58 } from './events/sonder/events_sonder_58.js'
import { EVENTS_SONDER_59 } from './events/sonder/events_sonder_59.js'
import { EVENTS_SONDER_60 } from './events/sonder/events_sonder_60.js'
import { EVENTS_SONDER_61 } from './events/sonder/events_sonder_61.js'
import { EVENTS_SONDER_62 } from './events/sonder/events_sonder_62.js'
import { EVENTS_SONDER_63 } from './events/sonder/events_sonder_63.js'
import { EVENTS_SONDER_64 } from './events/sonder/events_sonder_64.js'
import { EVENTS_SONDER_65 } from './events/sonder/events_sonder_65.js'
import { EVENTS_SONDER_66 } from './events/sonder/events_sonder_66.js'
import { FOLLOWTHROUGH_30_EVENTS } from './events/thematic/events_followthrough_30.js'
import { FOLLOWTHROUGH_31_EVENTS } from './events/thematic/events_followthrough_31.js'
import { FOLLOWTHROUGH_32_EVENTS } from './events/thematic/events_followthrough_32.js'
import { FOLLOWTHROUGH_33_EVENTS } from './events/thematic/events_followthrough_33.js'
import { FOLLOWTHROUGH_34_EVENTS } from './events/thematic/events_followthrough_34.js'
import { FOLLOWTHROUGH_35_EVENTS } from './events/thematic/events_followthrough_35.js'
import { FOLLOWTHROUGH_36_EVENTS } from './events/thematic/events_followthrough_36.js'
import { FOLLOWTHROUGH_37_EVENTS } from './events/thematic/events_followthrough_37.js'
import { FOLLOWTHROUGH_38_EVENTS } from './events/thematic/events_followthrough_38.js'
import { FOLLOWTHROUGH_39_EVENTS } from './events/thematic/events_followthrough_39.js'
import { FOLLOWTHROUGH_40_EVENTS } from './events/thematic/events_followthrough_40.js'
import { FOLLOWTHROUGH_41_EVENTS } from './events/thematic/events_followthrough_41.js'
import { FOLLOWTHROUGH_42_EVENTS } from './events/thematic/events_followthrough_42.js'
import { FOLLOWTHROUGH_43_EVENTS } from './events/thematic/events_followthrough_43.js'
import { FOLLOWTHROUGH_44_EVENTS } from './events/thematic/events_followthrough_44.js'
import { FOLLOWTHROUGH_45_EVENTS } from './events/thematic/events_followthrough_45.js'
import { FOLLOWTHROUGH_46_EVENTS } from './events/thematic/events_followthrough_46.js'
import { FOLLOWTHROUGH_47_EVENTS } from './events/thematic/events_followthrough_47.js'
import { FOLLOWTHROUGH_48_EVENTS } from './events/thematic/events_followthrough_48.js'
import { FOLLOWTHROUGH_49_EVENTS } from './events/thematic/events_followthrough_49.js'
import { FOLLOWTHROUGH_50_EVENTS } from './events/thematic/events_followthrough_50.js'
import { FOLLOWTHROUGH_51_EVENTS } from './events/thematic/events_followthrough_51.js'
import { FOLLOWTHROUGH_52_EVENTS } from './events/thematic/events_followthrough_52.js'
import { FOLLOWTHROUGH_53_EVENTS } from './events/thematic/events_followthrough_53.js'
import { FOLLOWTHROUGH_54_EVENTS } from './events/thematic/events_followthrough_54.js'
import { FOLLOWTHROUGH_55_EVENTS } from './events/thematic/events_followthrough_55.js'
import { FOLLOWTHROUGH_56_EVENTS } from './events/thematic/events_followthrough_56.js'
import { FOLLOWTHROUGH_57_EVENTS } from './events/thematic/events_followthrough_57.js'
import { FOLLOWTHROUGH_58_EVENTS } from './events/thematic/events_followthrough_58.js'
import { FOLLOWTHROUGH_59_EVENTS } from './events/thematic/events_followthrough_59.js'
import { FOLLOWTHROUGH_60_EVENTS } from './events/thematic/events_followthrough_60.js'
import { FOLLOWTHROUGH_61_EVENTS } from './events/thematic/events_followthrough_61.js'
import { FOLLOWTHROUGH_62_EVENTS } from './events/thematic/events_followthrough_62.js'
import { FOLLOWTHROUGH_63_EVENTS } from './events/thematic/events_followthrough_63.js'
import { FOLLOWTHROUGH_64_EVENTS } from './events/thematic/events_followthrough_64.js'
import { FOLLOWTHROUGH_65_EVENTS } from './events/thematic/events_followthrough_65.js'
import { FOLLOWTHROUGH_66_EVENTS } from './events/thematic/events_followthrough_66.js'
import { FOLLOWTHROUGH_67_EVENTS } from './events/thematic/events_followthrough_67.js'
import { FOLLOWTHROUGH_68_EVENTS } from './events/thematic/events_followthrough_68.js'
import { FOLLOWTHROUGH_69_EVENTS } from './events/thematic/events_followthrough_69.js'
import { FOLLOWTHROUGH_70_EVENTS } from './events/thematic/events_followthrough_70.js'
import { FOLLOWTHROUGH_71_EVENTS } from './events/thematic/events_followthrough_71.js'
import { FOLLOWTHROUGH_72_EVENTS } from './events/thematic/events_followthrough_72.js'
import { FOLLOWTHROUGH_73_EVENTS } from './events/thematic/events_followthrough_73.js'
import { FOLLOWTHROUGH_74_EVENTS } from './events/thematic/events_followthrough_74.js'
import { FOLLOWTHROUGH_75_EVENTS } from './events/thematic/events_followthrough_75.js'
import { FOLLOWTHROUGH_76_EVENTS } from './events/thematic/events_followthrough_76.js'
import { FOLLOWTHROUGH_77_EVENTS } from './events/thematic/events_followthrough_77.js'
import { FOLLOWTHROUGH_78_EVENTS } from './events/thematic/events_followthrough_78.js'
import { FOLLOWTHROUGH_79_EVENTS } from './events/thematic/events_followthrough_79.js'
import { FOLLOWTHROUGH_80_EVENTS } from './events/thematic/events_followthrough_80.js'
import { FOLLOWTHROUGH_81_EVENTS } from './events/thematic/events_followthrough_81.js'
import { FOLLOWTHROUGH_82_EVENTS } from './events/thematic/events_followthrough_82.js'
import { FOLLOWTHROUGH_83_EVENTS } from './events/thematic/events_followthrough_83.js'
import { FOLLOWTHROUGH_84_EVENTS } from './events/thematic/events_followthrough_84.js'
import { FOLLOWTHROUGH_85_EVENTS } from './events/thematic/events_followthrough_85.js'
import { FOLLOWTHROUGH_86_EVENTS } from './events/thematic/events_followthrough_86.js'
import { FOLLOWTHROUGH_87_EVENTS } from './events/thematic/events_followthrough_87.js'
import { FOLLOWTHROUGH_88_EVENTS } from './events/thematic/events_followthrough_88.js'
import { FOLLOWTHROUGH_89_EVENTS } from './events/thematic/events_followthrough_89.js'
import { FOLLOWTHROUGH_90_EVENTS } from './events/thematic/events_followthrough_90.js'
import { FOLLOWTHROUGH_91_EVENTS } from './events/thematic/events_followthrough_91.js'
import { FOLLOWTHROUGH_92_EVENTS } from './events/thematic/events_followthrough_92.js'
import { FOLLOWTHROUGH_93_EVENTS } from './events/thematic/events_followthrough_93.js'
import { FOLLOWTHROUGH_94_EVENTS } from './events/thematic/events_followthrough_94.js'
import { FOLLOWTHROUGH_95_EVENTS } from './events/thematic/events_followthrough_95.js'
import { PHILIPPINES_DEPTH_2_EVENTS } from './events/geographic/events_philippines_depth_2.js'
import { VENEZUELA_DEPTH_2_EVENTS } from './events/geographic/events_venezuela_depth_2.js'
import { SPECIFIC_LIFE_EVENTS } from './events/specific_lives/events_specific_lives.js'
import { ERA_GAP_EVENTS } from './events/thematic/events_era_gaps.js'
import { TEACHER_POWER_EVENTS } from './events/thematic/events_teacher_power.js'
import { DISEASE_ARC_EVENTS } from './events/thematic/events_disease_arcs.js'
import { SOUTH_SOUTH_EVENTS } from './events/thematic/events_south_south.js'
import { INTERPRETER_ARC_EVENTS } from './events/thematic/events_interpreter_arc.js'
import { DOCTOR_ARC_EVENTS } from './events/thematic/events_doctor_arc.js'
import { JOURNALIST_ARC_EVENTS } from './events/thematic/events_journalist_arc.js'
import { LAWYER_ARC_EVENTS } from './events/thematic/events_lawyer_arc.js'
import { NURSE_ARC_EVENTS } from './events/thematic/events_nurse_arc.js'
import { FARMER_ARC_EVENTS } from './events/thematic/events_farmer_arc.js'
import { POLICE_ARC_EVENTS } from './events/thematic/events_police_arc.js'
import { SOCIAL_WORKER_ARC_EVENTS } from './events/thematic/events_social_worker_arc.js'
import { ARTIST_ARC_EVENTS } from './events/thematic/events_artist_arc.js'
import { ENGINEER_ARC_EVENTS } from './events/thematic/events_engineer_arc.js'
import { DEV_ARC_EVENTS } from './events/thematic/events_dev_arc.js'
import { FACTORY_ARC_EVENTS } from './events/thematic/events_factory_arc.js'
import { LABORER_ARC_EVENTS } from './events/thematic/events_laborer_arc.js'
import { CIVIL_SERVANT_ARC_EVENTS } from './events/thematic/events_civil_servant_arc.js'
import { DRIVER_ARC_EVENTS } from './events/thematic/events_driver_arc.js'
import { CHEF_ARC_EVENTS } from './events/thematic/events_chef_arc.js'
import { MERCHANT_ARC_EVENTS } from './events/thematic/events_merchant_arc.js'
import { ACCOUNTANT_ARC_EVENTS } from './events/thematic/events_accountant_arc.js'
import { PALESTINE_DEPTH_EVENTS } from './events/geographic/events_palestine_depth.js'
import { MEMORY_LAYER_EVENTS } from './events/thematic/events_memory_layer.js'
import { ROADS_NOT_TAKEN_EVENTS } from './events/thematic/events_roads_not_taken.js'
...
const BASE_EVENTS = [
  ...
  },
  {
    ...
    context: null,
    choices: null,
    effect: (p) => { p.m -= 8; p.r += 5; p.addFlag('lost_parent_young'); p.killParent(randomBetween(0, 1) > 0 ? 'father' : 'mother'); },
  },
  {
  ...
  },
  {
    ...
    phase: 'childhood',
    weight: 2,
    // `when: () => true`, so "Faith is a major presence in your home. You are
    // expected to participate" fired for a secular Swede and an atheist Czech.
    // Thirteen events in this file have no guard at all; this is the one where
    // that is a statement about the character rather than about being a child.
    when: (G) => !['secular', 'atheist'].includes(G.religion) && G.religion != null,
  ...
  },
  {
    ...
    phase: 'midlife',
    weight: 2,
    // "The company restructures. Your role is eliminated" fired for a serving
  ...
  },
  {
    ...
    when: (G) =>
      ...
      G.age >= 22 && G.age <= 30 &&
      !G.mem?.studentLoanReckoning,
    text: (G) => {
      const country = G.character.country?.name || ''
      if (country === 'United States' || country === 'USA')
        return 'The loan statement arrives in a year when you are also paying rent and eating and trying to start something. The total balance — principal plus accumulated interest — is larger than it was when you graduated. You have been making payments. The payments have been going to interest. The principal has barely moved. This is how the product was designed.'
      if (country === 'United Kingdom' || country === 'UK')
        return 'The student loan company calculates your repayment at nine percent of earnings above the threshold. In practice this means you will still be repaying in your fifties unless you earn significantly above median wage for your entire working life. This is the normal situation for people who went to university after 2012. Everyone treats it as normal.'
      return 'The student loan is not like other debt. There is no defaulting on it in the conventional sense. It simply follows you — a fraction of every paycheque, for years, for decades, until either the balance is cleared or enough time passes for it to be written off. It is background noise until it is not. Today it is not.'
    },
    choices: [
      { text: 'Set up an aggressive repayment plan', tag: null, outcome: 'You pay more than the minimum. It takes years. You do not go on holiday during them.', effect: (p) => { p.mo -= 2000; p.m -= 5; p.e += 3; p.setMem('studentLoanReckoning', true) }, inject: null },
      { text: 'Pay the minimum and carry it', tag: null, outcome: 'The number stays large for a long time. So does the life you\'re building alongside it.', effect: (p) => { p.m -= 3; p.setMem('studentLoanReckoning', true) }, inject: null },
    ],
    effect: null,
  },
  ...
  // FAME EVENTS
  {
    ...
    choices: [
      { text: 'Ignore it — engagement only amplifies it', tag: 'yielding', outcome: (G) => G.currentYear >= 2000 ? 'It dies in a week. The internet moves on. It is also still there, three pages down, for the rest of your life.' : 'It dies in a week. In six months nobody has the cutting and everybody remembers the shape of it.', effect: (p) => { p.m -= 5; p.fame -= 3; p.setMem('tabloidEvent', true); }, inject: null },
      ...
      { text: 'Use it — any publicity is publicity', tag: 'defiant', outcome: 'The notoriety converts to attention and the attention converts to work, and the person you have to be in order to do that is a person you did not choose and are now contracted to.', effect: (p) => { p.m -= 8; p.fame += 8; p.karma -= 3; p.addFlag('traded_on_the_scandal'); p.setMem('tabloidEvent', true); }, inject: null },
    ],
    effect: null,
  },
  {
...
// Widened after a beta read found nine of nine never-schooled lives collecting
// school prose — "You spend every recess with the same person" at 6, "An older
// child at school has made you their target" at 8, "Something happens during
// the assembly, the shoulders, the tears, the teacher's face" at 14 — all in a
// life the game itself narrated as "The other children go and you do not."
...
export function classifyEvent(e) {
  ...
  // The phase restriction meant 89 `phase: null` events with school prose were
  ...
  else e.register = 'universal'
  return e
}

// Stranger glimpses — the pan to a life that is not yours, which gives the game
// its name. CLAUDE.md promises one "roughly once per decade"; left to compete in
// the open pool they landed 0.3 times per life. Selection now schedules them, so
...
export const EVENT_REGISTERS = ['anchored', 'earned', 'universal', 'contemplative']
