    ...
    choices: [
      {
        ...
        effect: (p) => { p.e += 6; p.m -= 6; p.addFlag('political_awareness_early'); p.setPolitical('dissident'); p.setMem('adolPoliticalAwakening', true) },
      },
      {
        ...
        effect: (p) => { p.e += 8; p.s += 4; p.addFlag('political_awareness_early'); p.addFlag('dissident_sympathies'); p.setPolitical('dissident'); p.setMem('adolPoliticalAwakening', true) },
      },
    ],
    effect: null,
  },
