...
const REALIZATION_EVENTS = [
...

  {
    ...
    text: (G) => {
      ...
      if (type === 'musical') return 'You play with someone who is as good as you. Not a hero — an equal. The session lasts four hours and at the end you are both exhausted in the way that comes from being truly extended. You have never been in a musical conversation like this. You hadn\'t known you were missing it.'
...

  {
    ...
    text: (G) => {
      ...
      if (type === 'artistic') return 'The work has changed. Not technically — you\'ve been able to do this for twenty years. Something else: it knows something now that it didn\'t know before. The grief, the displacement, the texture of a life that went through the things yours went through — it\'s in the work. The gift and the biography have finally become the same thing.'
