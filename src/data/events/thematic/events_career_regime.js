...
export const CAREER_REGIME_EVENTS = [
  ...
  },
  {
    ...
    text: (G) => `A prize, an exhibition, a review in a European publication. The government's response is measured and quick: this is foreign interference, cultural imperialism, an attempt to destabilize. The work, which was suppressed domestically, is now a diplomatic incident. ${G.currentYear >= 2005 ? 'You sit in your studio and look at your phone.' : 'You sit in your studio and wait for the telephone to ring, and it does not, and that is its own message.'}`,
    choices: [
