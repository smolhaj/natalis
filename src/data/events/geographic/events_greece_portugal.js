...

  {
    ...
    choices: [
      ...
      },
      {
        ...
        effect: (p) => { p.m -= 10; p.addFlag('emigrated'); p.emigrateTo(['Germany', 'Netherlands', 'United Kingdom']); p.addFlag('greece_crisis_emigrant'); p.setResidency('work_visa'); p.setMem('grDebt', true) },
      },
    ],
    effect: null,
  },
...

  {
    ...
    choices: [
      ...
      },
      {
        ...
        effect: (p) => { p.m -= 10; p.m += 8; p.addFlag('emigrated'); p.emigrateTo('France'); p.addFlag('colonial_war_evaded'); p.setResidency('work_visa'); p.setMem('ptWar', true) },
      },
    ],
    effect: null,
  },
