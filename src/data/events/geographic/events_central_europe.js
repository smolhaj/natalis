...

  {
    ...
    choices: [
      ...
      },
      {
        ...
        effect: (p) => { p.r += 8; p.m -= 8; p.addFlag('hungarian_1956_generation'); p.addFlag('hungarian_diaspora_1956'); p.addFlag('emigrated'); p.emigrateTo(['Austria', 'United States', 'Canada', 'United Kingdom'], { residency: 'refugee_status' }); p.setMem('hun1956', true); },
      },
    ],
    effect: null,
  },
...

  {
    ...
    choices: [
      ...
      },
      {
        ...
        effect: (p) => { p.r += 5; p.m -= 5; p.addFlag('orban_era_generation'); p.addFlag('emigrated'); p.emigrateTo(['United Kingdom', 'Germany', 'Austria']); p.setMem('hunOrban', true); },
      },
    ],
    effect: null,
  },
