...
export const GUYANA_EVENTS = [
...

  {
    ...
    choices: [
      {
        text: 'Join the union. After this, people will.',
        tag: 'defiant',
        outcome: 'You pay dues you cannot spare to an organisation the estate does not recognise. It takes another twenty-eight years before it is recognised, and you are still alive when it is.',
...

  {
    ...
    text: 'In April the colony votes for the first time with everybody allowed to vote, and the PPP takes eighteen of twenty-four seats, At the end of May the government takes office, and it lasts a hundred and thirty-three days. In October the warship comes. Troops off HMS Superb come up the Demerara and into Georgetown, the constitution is suspended, and the reason given on the radio is that the government intends to make this place a communist state. The government has been in office since April. You try to work out what it could possibly have had time to do.',
...

  {
    ...
    text: 'On the twenty-third of February the country becomes the Co-operative Republic of Guyana, which is the only co-operative republic in the world, and there is a festival for it called Mashramani, which is said to be an Amerindian word for the celebration after co-operative work. The first one is in Linden and people travel up for it — floats and costume bands and a competition for the best one. The co-operative part of it is going to mean, over the next fifteen years, that the state owns the sugar, the bauxite, the banks, the rice board and most of the shops. On the twenty-third of February nobody has told you that part.',
    choices: null,
...

  {
    ...
    phase: null,
    weight: 999,
    when: (G) => IS_GY(G) && G.currentYear >= 1982 && G.currentYear <= 1986 && G.age >= 8 && once(G, 'gy_flour'),
    ...
    context: 'From 1982 the Burnham government banned imports of wheat flour and a range of staples to force self-sufficiency. Shortages, queues and a large smuggling economy across the Corentyne River to Suriname followed. The flour ban was lifted in 1986 after a PL 480 wheat agreement with the United States; bans on other staples ran on into the Economic Recovery Programme at the end of the decade.',
    choices: [
      {
...

  {
    ...
    text: 'Nine hundred and eighteen people die in November, nine hundred of them at one compound in the North West District, and almost none of them are Guyanese. It was an American compound on land the government leased them, out in the bush where nobody went, and the first most of the country hears of it is the aircraft coming and going at Port Kaituma and then the world\'s press arriving in Georgetown in numbers the hotels cannot hold. For the rest of your life, when you are abroad and you say where you are from, a certain number of people will say one word back to you. It will be that word.',
    context: 'On 18 November 1978, 918 people died in all: 909 at the Peoples Temple settlement in Guyana\'s North West District, five at the Port Kaituma airstrip including US Congressman Leo Ryan, and four in Georgetown. Almost all of the dead were American. The settlement had been established on land leased from the Guyanese government in 1974.',
    choices: null,
...

  {
    ...
    phase: null,
    weight: 6,
    when: (G) => IS_GY(G) && (FIRST(G) || G.place?.id === 'gy_rupununi') && G.currentYear >= 1985 && G.age >= 20 && once(G, 'gy_merc'),
