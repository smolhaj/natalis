...
import { hasFlown, hasHealthcare, hasPhotographs, hasRadio, hasTV, isLiterate, isUrban, worksInOffice } from './_sonderGuards.js'
...

{
    ...
    phase: 'adolescence',
    weight: 2,
    when: (G) => hasRadio(G) && (G.age >= 13 && G.age <= 18 && !G.mem?.s41g),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => isUrban(G) && (G.age >= 38 && !G.mem?.s41h),
...

{
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => hasFlown(G) && (G.age >= 35 && !G.mem?.s41j),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => hasPhotographs(G) && (G.age >= 60 && !G.mem?.s41m),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => hasHealthcare(G) && (G.age >= 32 && !G.mem?.s41p),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => isLiterate(G) && (G.age >= 58 && !G.mem?.s41q),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => worksInOffice(G) && (G.age >= 30 && !G.mem?.s41s),
...

{
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => hasTV(G) && (G.age >= 30 && !G.mem?.s41ab),
