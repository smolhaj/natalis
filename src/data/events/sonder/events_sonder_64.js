...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s64m,
    text: 'The thing you were certain about at twenty-four was wrong in a way you could not have identified at twenty-four. You know now. The knowing now doesn\'t help the twenty-four-year-old. You are protective of the certainties of people that age in a way that is not quite sympathy.',
    choices: null,
...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s64x,
    text: 'The work that paid least is the work you remember in the most sensory detail. The texture of the surface, the smell, the hour of the day, the name of the person you worked alongside. High-stakes work is remembered differently — by outcome, by anxiety. The low-stakes work is remembered as texture.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s64aa,
    text: 'The meal that was special — the food that only came on certain days, for certain reasons, from a specific person who made it — is retrievable as a taste that is also a specific set of circumstances: the table, the hour, the permission that the food represented.',
    choices: null,
