...
export const EVENTS_SONDER_26 = [
...

  {
    ...
    phase: null,
    weight: 2,
    when: (G) => place.isLiterate(G) && (G.age >= 20 && !G.mem?.sdr26QueueNumber),
    text: () => pick([
...

  {
    ...
    phase: null,
    weight: 2,
    when: (G) => place.isLiterate(G) && (G.age >= 25 && !G.mem?.sdr26ExpiredDoc),
    text: () => pick([
...

  {
    ...
    phase: null,
    weight: 2,
    when: (G) => place.hasPhone(G) && (G.age >= 14 && !G.mem?.sdr26BusLong),
    text: () => pick([
...

  {
    ...
    phase: null,
    weight: 2,
    when: (G) => place.hasBooks(G) && (G.age >= 42 && !G.mem?.sdr26ReadingGlasses),
    text: () => pick([
...

  {
    ...
    phase: null,
    weight: 2,
    when: (G) => place.isLiterate(G) && (G.age >= 28 && !G.mem?.sdr26OldPaper),
    text: () => pick([
...

  {
    ...
    phase: null,
    weight: 2,
    when: (G) => place.hasPhotographs(G) && (G.age >= 20 && !G.mem?.sdr26IdPhoto),
    text: () => pick([
