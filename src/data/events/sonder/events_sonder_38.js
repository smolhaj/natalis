...

{
    ...
    weight: 2,
    when: (G) => !G.mem?.s38r,
    text: 'The taste of something that only existed in one place at one time: the thing your grandmother made that no one has replicated, the street food from the corner that is no longer there. The taste is in the memory as a fact but cannot be verified or reproduced. This is a kind of knowledge that decays and cannot be backed up.',
    choices: null,
...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s38ab,
    text: 'The project you finished. It is done and has been done for years and exists as a completed thing, which is different from everything that is still ongoing. You return to it occasionally with the feeling of having done something that is actually finished. The feeling is not available from the things that are still ongoing, which is most things.',
    choices: null,
