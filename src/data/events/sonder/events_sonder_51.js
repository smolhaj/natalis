...

{
...

  {
    ...
    text: 'The pleasure of being in a place you know so well that you navigate it without sight — the stairs in the dark, the path to the bathroom at 3am, the kitchen in the early morning before the light is on. The body has mapped this space. The map is accurate. The navigation happens before the awareness of navigating.',
    choices: null,
...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s51ab,
    text: 'The sound of adults laughing in another room. Not seeing the joke, just hearing the laughter. The sound has a quality when you are not in the room — warm and separate, the adults doing something adults do that is not available to you yet. You listen from outside it. You will have access eventually. Right now you are listening to the category of things you do not yet have access to.',
    choices: null,
