...
export const SONDER_EVENTS = [
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.hasElectricity(G) && (G.age >= 18 && G.age <= 30 && !G.mem?.sonderLitWindow),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasCar(G) && (G.age >= 28 && G.age <= 52 && !G.mem?.sonderChildWaveWindow),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasHealthcare(G) && (G.age >= 55 && !G.mem?.sonderHospitalRooftop),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.isLiterate(G) && (G.age >= 58 && !G.mem?.sonderWeddingPhoto),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasPhotographs(G) && (G.age >= 58 && !G.mem?.mundanePhotographUnseen),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.wentToSchool(G) && (G.age >= 30 && G.age <= 50 && G.children?.length > 0 && !G.mem?.mundaneSchoolRunYears),
...

  {
    ...
    phase: 'childhood',
    weight: 2,
    when: (G) => place.wentToSchool(G) && (G.age >= 6 && G.age <= 14 && !G.mem?.mundaneDeskNeighbour),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasClock(G) && (G.age >= 60 && !G.career && !G.mem?.mundaneRetirementMorning),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasWeekend(G) && (G.age >= 65 && !G.mem?.mundaneLongNap),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasHealthcare(G) && (G.age >= 60 && !G.mem?.mundaneDoctorRelationship),
...

  {
    ...
    phase: 'adolescence',
    weight: 2,
    when: (G) => place.hasPhotographs(G) && (G.age >= 13 && !G.mem?.sonderParentOldPhoto),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasPhotographs(G) && (G.career && G.age >= 36 && !G.mem?.sonderColleagueDeskPhoto),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasHealthcare(G) && (G.age >= 35 && !G.mem?.sonderHospitalWardNight),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.isUrban(G) && (G.age >= 34 && !G.mem?.sonderNeighbourLightSameHour),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasHealthcare(G) && (G.age >= 60 && !G.mem?.sonderHospitalOrdinaryWork),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasHealthcare(G) && (G.age >= 38 && !G.mem?.sonderOldManHospitalCorridor),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasCafe(G) && (!G.mem?.sonderCoupleArgumentPublic),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasBooks(G) && (!G.mem?.sonderLibraryAbsorbedReader),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasSupermarket(G) && (G.age >= 42 && !G.mem?.sonderWidowShoppingForOne),
...

{
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.hasPhotographs(G) && ((G.flags.has('ofw_hongkong') || (G.character?.country?.name === 'Philippines' && G.flags.has('ofw_worker'))) && !G.mem?.sonderOfwVictoriaPark),
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.isUrban(G) && ((G.character?.country?.name === 'Jordan' || G.character?.country?.name === 'Saudi Arabia') && !G.mem?.sonderBedouinTentCityEdge),
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.worksInOffice(G) && (G.character?.gender === 'female' && G.career && G.age >= 22 && !G.mem?.sonderYoungWomanIdeaCredited),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.wentToSchool(G) && (G.character?.gender === 'male' && G.children?.length > 0 && G.age >= 35 && !G.mem?.sonderFathersSchoolGate),
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.hasMetro(G) && ((G.character?.country?.name === 'South Africa' || G.character?.country?.name === 'Zambia' || G.character?.country?.name === 'Chile' || G.character?.country?.name === 'Bolivia' || G.character?.country?.name === 'Colombia') && !G.mem?.sonderMineShiftSurfaces),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasSupermarket(G) && (G.age >= 58 && !G.mem?.sonderDementiaCoupleSuper),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasCafe(G) && (G.age >= 42 && !G.mem?.sonderCarerParentPublic),
...

  {
    ...
    phase: 'childhood',
    weight: 2,
    when: (G) => place.wentToSchool(G) && (!G.mem?.sonderSchoolGateFirstDay),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasPhone(G) && (!G.mem?.sonderGoodNewsPhonePublic),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.isUrban(G) && (G.age >= 65 && !G.mem?.sonderVeryOldMomentarilyLost),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasHealthcare(G) && (!G.mem?.sonderMaternityWardEmergence),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasBooks(G) && (G.age >= 38 && !G.mem?.sonderHouseEmptiedAfterDeath),
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => place.hasCar(G) && (G.age >= 35 && !G.mem?.sonderManCryingAloneCar),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasCar(G) && (G.age >= 30 && !G.mem?.sonderArgumentWitnessedRestaurant),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasElectricity(G) && ((G.character?.country?.archetype === 'post_soviet' || G.character?.country?.name === 'Russia') && G.age >= 55 && !G.mem?.sonderSovietApartmentWindow),
...

  {
    ...
    phase: 'adolescence',
    weight: 2,
    when: (G) => place.hasBooks(G) && (G.age >= 13 && G.age <= 18 && !G.mem?.sonderLibraryLateAfternoon),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.isUrban(G) && (G.age >= 40 && G.flags.includes('lost_parent') && !G.mem?.sonderInheritedApartment),
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.hasCar(G) && ((G.character?.country?.archetype === 'subsaharan' || G.character?.country?.archetype === 'developing_urban') &&
      G.age >= 18 && G.age <= 35 &&
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => G.age >= 4 && place.hasHealthcare(G) && !G.mem?.sonderGlimpseEcOtherChild,
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => G.age >= 7 && place.wentToSchool(G) && !G.mem?.sonderGlimpseChTeacher,
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => G.age >= 8 && place.hasElectricity(G) && G.season === 'winter' && !G.mem?.sonderGlimpseChLitWindow,
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => G.age >= 13 && place.hasElectricity(G) && place.isUrban(G) && !G.mem?.sonderGlimpseAdStudying,
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => G.age >= 12 && place.isHotCountry(G) && !G.mem?.sonderGlimpseAdFamilyOutside,
...

  {
    ...
    weight: 2,
    isGlimpse: true,
    when: (G) => G.age >= 58 && place.hasHealthcare(G) && !G.mem?.sonderGlimpseLlNurse,
