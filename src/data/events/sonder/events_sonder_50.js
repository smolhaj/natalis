...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s50v,
    text: 'The pleasure of a task completed that had been undone for a long time. Not the task itself — the state of having completed it. The shelf assembled, the letter replied to, the call made. Something was in the air before; now it is resolved. You are aware that the pleasure is disproportionate to the difficulty of the task. You do not mind.',
    choices: null,
...

{
    ...
    text: 'The quality of being ill as a child — the particular texture of days that are outside normal days. The permission to lie on the sofa. The different light. The television at unusual hours. The body that is unwell and also in a container of slight exemption from the usual requirements. You are not glad to be ill but you notice the register of it.',
    choices: null,
