...
export const EVENTS_SONDER_57 = [
...

  {
    ...
    text: 'Seen from a car window, the old neighbourhood. It has changed and you are relieved that it has changed and also slightly aggrieved that it has changed without your permission. Both reactions are unreasonable. You have them anyway.',
    choices: null,
...

  {
    ...
    text: 'You have been about to say it for three years. It is in your head in the form of a sentence. You know who you would say it to and what the occasion for saying it would be. The occasion has not quite arrived and the sentence waits.',
    choices: null,
...

{
    ...
    text: 'A gift was wrong — wrong size, wrong colour, meant for someone else, bought out of obligation. You learn to say thank you for the wrong gift. The learning is useful and also a small form of corruption.',
    choices: null,
...

  {
    ...
    text: 'News accumulates over a lifetime — the disasters and elections and assassinations and recessions — has produced in you a particular quality of perspective that the young people around you do not yet have. You are not sure it is wisdom. It is at least scale.',
    choices: null,
...

  {
    ...
    text: 'The song that represents this period so completely that hearing it in thirty years will reconstruct not just the memory but the quality of being alive at sixteen — the particular texture of that afternoon in particular, which was neither good nor bad but simply is, preserved in the song.',
    choices: null,
...

{
    ...
    text: 'You sit in a meeting with more than one idea and say neither of them. You are learning something. Whether it is the right thing to learn is a question you will be answering for the rest of your working life.',
    choices: null,
...

  {
    ...
    text: 'You grew up there and left, and now people your age are moving there because it is cheaper than where you moved to. The geography of affordable has shifted around you in ways that make the decisions of your twenties look both arbitrary and inevitable.',
    choices: null,
...

  {
    ...
    text: 'A game only works with exactly four players and you can only find three. You try with three. It does not work with three. The game waits for the fourth player, who may or may not appear before summer is over.',
    choices: null,
...

{
...

  {
    ...
    text: 'A choice felt large at twenty-four — the job, the city, the relationship — looks different at twenty-nine. Not smaller. Just more in context. You can see the contingency around it now. The contingency was always there. You were too close to it to see the frame.',
    choices: null,
...

  {
    ...
    text: 'Light falls on the same wall at the same time of year. You notice it every year now. You noticed it before but not with this attention. The attention is the thing that changed. The light has always been the same.',
    choices: null,
...

  {
    ...
    text: 'You paid someone a compliment years ago and forgot it entirely, and they mention it now, unexpectedly, as the thing that changed how they thought about themselves. You do not remember the compliment. They have been carrying it for fifteen years.',
    choices: null,
