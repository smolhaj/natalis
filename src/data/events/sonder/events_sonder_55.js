...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55n,
    text: 'The sound of rain on a particular roof. Not rain in general — rain on this specific material (corrugated iron, tile, flat felt, lead flashing) producing this register. You know what rain sounds like in the house you grew up in and in any house since then there is a comparison being made without your asking for it. The original sound is still the reference. All other rain is rain-compared-to-that.',
    choices: null,
