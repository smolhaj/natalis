...
export const EVENTS_SONDER_55 = [
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55e,
    text: 'You have not spoken in years and would recognise the voice immediately. The relationship has been on hold rather than ended. You both know this without having discussed it. The maintenance has been suspended without the attachment being cancelled. At some specific moment one of you will call and the conversation will resume from something close to where it stopped.',
    choices: null,
...

{
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => G.season === 'summer' && (!G.mem?.s55j),
    text: 'A summer evening in your twenties had a quality you cannot reproduce. You cannot reproduce the feeling — you have tried on subsequent summer evenings. Something in it was produced by a combination of circumstances that has not repeated: the people, the place, the moment in your life. The memory is very precise about what it felt like. It is imprecise about what exactly happened. The feeling is the thing that was kept.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55l,
    text: 'Silence, after a long argument. Not the productive silence where something is being processed — the silence where both people have said everything and neither of them knows what comes next. This silence has a texture that depends on what came before it. The next thing said will have to carry the whole weight of the argument plus the silence. Usually someone says something small. The small thing is not small.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55n,
    text: 'Rain on a particular roof makes a sound you know. Not rain in general — rain on this specific material (corrugated iron, tile, flat felt, lead flashing) producing this register. You know what rain sounds like in the house you grew up in and in any house since then there is a comparison being made without your asking for it. The original sound is still the reference. All other rain is rain-compared-to-that.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55q,
    text: 'Accumulation. Not any one thing — the accumulation of experience, of knowledge, of consequence, of having done things and said things and been in places and made decisions that became other decisions. You could not have held this much at thirty. Thirty-year-old you was also richer — more possibility, more time, the future still large. You have traded one kind of wealth for another, and the exchange was not voluntary, and you are not sure the terms were fair, and they were also the only terms available.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55t,
    text: 'You decided in a bad state of mind and turned out to be right. You were exhausted, or grieving, or angry, or unwell. You made a decision you should not have been making in that state. The decision was right. You cannot claim credit for reasoning — you were not reasoning well. The decision was right anyway. This is unsettling in a way that good decisions made from good reasoning are not.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55x,
    text: 'You invented a game with one other child. Not a game that existed before — something specific to the two of you, with rules that would mean nothing to anyone else, with geography that was yours: this patch of ground, this specific corner, this time of day. The game existed only while both of you played it. When you stopped playing, the game ended. Nobody else has ever played it or will.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s55z,
    text: 'You gave a gift once and it landed perfectly. Not an expensive gift — the gift that was right in a way that expensive gifts often are not. The person received it and you could see that they received it, that it found something specific. This is rare. You knew it was rare at the time. The memory of the moment they opened it is more vivid than the object itself.',
    choices: null,
