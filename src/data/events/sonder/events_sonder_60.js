...
export const EVENTS_SONDER_60 = [
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s60b,
    text: 'There is a quality to the tiredness you feel at the end of a day when nothing went wrong. It is different from the tiredness of difficulty. It is heavier.',
    choices: null,
...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s60s,
    text: 'There is a silence between people who have known each other long enough. It does not need filling. You have this with one person. Possibly two. The number is not going to get larger.',
    choices: null,
