...

{
...

  {
    ...
    text: 'The time a friendship shifted from something maintained out of history into something you actually want. The friendship was there before; you showed up for the occasions; then at some point the showing up became something you would choose even without the history. You know roughly when it happened. You do not mention it because there is no occasion to mention it.',
    choices: null,
...

  {
    ...
    text: 'The pleasure of doing one thing well for a long time. You have been doing this thing — any thing, it doesn\'t matter what — for fifteen years. The pleasure is not in the novelty; it is in the grain of experience that accumulates: the small variations you can now perceive that a beginner cannot, the patterns that took a decade to become visible.',
    choices: null,
...

{
...

  {
    ...
    text: 'The early morning of a city before the city wakes. The quality: the same streets you know from afternoon, emptied out, the light still low, the few people you see either very tired or very awake. The city before it starts is a different city from the city you live in the rest of the day.',
    choices: null,
