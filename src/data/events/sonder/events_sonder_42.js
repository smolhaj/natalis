...

{
...

  {
    ...
    text: 'An adult tells the event one way and you witnessed another. They tell the story one way. You remember it differently. You are young enough that the adult version wins, becomes the official account, and your version recedes. For years afterward you are not sure what you actually saw.',
    choices: null,
...

  {
    ...
    text: 'A friendship shifted, at some point, from something maintained out of history into something you actually want. The friendship was there before; you showed up for the occasions; then at some point the showing up became something you would choose even without the history. You know roughly when it happened. You do not mention it because there is no occasion to mention it.',
    choices: null,
...

  {
    ...
    text: 'Your grandchildren will not be able to imagine the era you lived in. Not technology — the texture of a day before certain things existed. The quiet. The slower correspondence. The not-knowing where someone was if they did not tell you. You lived in that world for decades. It is as gone as gaslight.',
    choices: null,
...

  {
    ...
    text: 'You have done one thing well for a long time. You have been doing this thing — any thing, it doesn\'t matter what — for fifteen years. The pleasure is not in the novelty; it is in the grain of experience that accumulates: the small variations you can now perceive that a beginner cannot, the patterns that took a decade to become visible.',
    choices: null,
...

  {
    ...
    text: 'Alone in a house for a whole night, the first time. Your parents are away. The house has a different character when it is only yours: its sounds are louder, its spaces are larger, the darkness at the end of the corridor is specifically yours to walk into or not. You stay up too late. You do something you would not do if they were here. It is very minor. It is also the beginning of something.',
    choices: null,
...

  {
    ...
    text: 'Your body carries knowledge the mind has not yet processed. A smell, a texture, a chord — and before you know why, something is happening in your chest. The mind catches up a second later and names the connection. The body arrived first. This has been true your whole life. You notice it more now.',
    choices: null,
...

{
    ...
    text: 'A game required everyone to believe in it or it did not work. If one person stopped believing, stopped following the rules you all invented, the game ended — not because it was a bad game, but because all games require collective agreement to be real. You understood this before you had words for it.',
    choices: null,
...

{
...

  {
    ...
    text: 'A child you know well stops needing your help with something they used to need help with. No ceremony. You just notice it is not happening anymore: they are doing it themselves. The transition was gradual and is only visible in retrospect. You are glad. Something small has ended.',
    choices: null,
...

{
...

  {
    ...
    text: 'Early morning, before the city wakes. The quality: the same streets you know from afternoon, emptied out, the light still low, the few people you see either very tired or very awake. The city before it starts is a different city from the city you live in the rest of the day.',
    choices: null,
...

  {
    ...
    text: 'Rain arrives while you are somewhere without shelter. You did not plan for it. You are immediately, completely wet. The inconvenience is real and total. Something small in the situation makes it funny rather than frustrating — the thoroughness of it, the simplicity. You arrive wherever you are going soaked through. Someone hands you something dry.',
    choices: null,
