...
export const EVENTS_SONDER_59 = [
...

  {
    ...
    text: 'The day you realised you had become the person in the room who remembered when the previous version existed: the building before it was renovated, the company before the acquisition, the system before the update. The remembering makes you useful in a way and also marks you as belonging to an earlier version. You carry both states — the usefulness and the markedness — without complaint, mostly.',
    choices: null,
