...
export const EVENTS_SONDER_59 = [
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasMobile(G) && (G.age >= 36 && G.age <= 52 && !G.mem?.s59g),
    text: 'You composed it and deleted it. You got through the whole sentence — sometimes two — and then you read it back and saw something in it that made you delete it. The person you were going to send it to does not know it was composed. What you deleted was true. Sending it would have started a different conversation, and you have decided, for reasons you cannot fully articulate, that this is not the moment for that conversation.',
    choices: null,
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.hasHousingMarket(G) && (G.age >= 24 && G.age <= 32 && !G.mem?.s59h),
    text: 'Whoever owned the flat: the relationship is transactional and also strangely intimate — you pay them money every month; they have a key; they can enter, technically, with notice. The flat is yours while also not being yours. The relationship ends when you leave and you never think about the landlord again, and presumably they do not think about you.',
    choices: null,
...

  {
    ...
    text: 'Somewhere that was yours alone: the corner behind the sofa, the space under the stairs, the cupboard in the back room. The hiding place had no purpose beyond being the place you could be that no one else knew about. The feeling of being in it was the feeling of being temporarily exempt from the requirements of being visible. The hiding place got too small eventually. You remember when that happened.',
    choices: null,
...

  {
    ...
    text: 'You understand something about your field that takes twenty minutes to explain and cannot be made shorter without losing it. You have tried to make it shorter. The shorter version is a different thing. You have accepted that the twenty minutes is the price of the understanding and you pay it each time someone sincerely wants to understand.',
    choices: null,
...

  {
    ...
    text: 'One day you realise you are the person in the room who remembers the previous version: the building before it was renovated, the company before the acquisition, the system before the update. The remembering makes you useful in a way and also marks you as belonging to an earlier version. You carry both states — the usefulness and the markedness — without complaint, mostly.',
    choices: null,
...

  {
    ...
    phase: 'childhood',
    weight: 2,
    when: (G) => place.hasRadio(G) && (G.age >= 9 && G.age <= 14 && !G.mem?.s59r),
    text: 'A long journey by car: the window, the changing landscape, the radio that faded in and out, the game you invented to pass the time that only worked in the car. The family is contained in the car for hours. The containment is its own texture — the arguments that are minor because there is nowhere to go, the silences that are fine because everyone is looking at the same road.',
    choices: null,
...

  {
    ...
    text: 'Ordinary days, accumulating: you have had so many ordinary days that they have become a form of richness. The Tuesday that was not remarkable. The Wednesday that was not remarkable. Wednesday after Wednesday that, taken together, are the interior of what a life is. The unremarkable days are most of it. You have stopped wanting most of it to be remarkable.',
    choices: null,
...

{
...

  {
    ...
    text: 'Someone younger reminds you of yourself and will not take the advice you would have needed: the advice arrives too early, or in the wrong form, or from someone who is not yet known well enough for the advice to land. You know this. You give the advice anyway. The giving is for you as much as for them.',
    choices: null,
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasHealthcare(G) && (G.age >= 44 && !G.mem?.s59ad),
    text: 'Three years of the same bus, and the other people who were also taking it every day: not friends, but people who knew each other in the silent register of shared routine. The man who always sat in the same seat. The woman who read a physical newspaper into the early 2010s. The particular light at the stop near the hospital. You can see the route in your head twenty years later. The people on it are alive somewhere or they are not.',
    choices: null,
