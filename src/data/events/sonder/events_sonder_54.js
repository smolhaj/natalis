...

{
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.wentToSchool(G) && (!G.mem?.s54b),
...

  {
    ...
    phase: 'late_life',
    weight: 2,
    when: (G) => place.hasPhotographs(G) && (!G.mem?.s54c),
...

  {
    ...
    phase: 'childhood',
    weight: 2,
    when: (G) => place.hasRadio(G) && (!G.mem?.s54e),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasPhotographs(G) && (!G.mem?.s54h),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.isLiterate(G) && (!G.mem?.s54i),
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.hasSupermarket(G) && (!G.mem?.s54n),
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.worksInOffice(G) && (!G.mem?.s54t),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasPhone(G) && (!G.mem?.s54v),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasPhotographs(G) && (!G.mem?.s54aa),
