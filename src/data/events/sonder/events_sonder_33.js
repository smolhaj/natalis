...

{
    ...
    text: () => pick([
      'Your parents were this age once, and you were young. You understand some things about them that you did not understand when they were this age and you were younger.',
      'Something was supposed to have resolved by now and has not. The resolution is no longer the point. What you are doing with the unresolved thing is the point.',
    ]),
    choices: null,
...

  {
    ...
    text: () => pick([
      'A grandchild, or some young person, asks you what it was like. What it was like is not a story — it was the daily texture of a life, and the daily texture does not compress well. You tell them something true and insufficient.',
      'You have outlasted several things you thought would break you. Not pride exactly. More like the knowledge that you are more durable than you believed.',
    ]),
    choices: null,
...

  {
    ...
    text: () => pick([
      ...
      'You are in the middle of something. The middle of a project is the hardest part: past the excitement of beginning, not yet at the clarity of the end, inside the sustained effort that no one else can see.',
    ]),
    choices: null,
...

  {
    ...
    text: () => pick([
      'A decision got made without deciding. Not a choice but a drift that accumulated into a direction. You are in the direction now and it is more or less where you would have chosen.',
      'You used to be friends and have not spoken in eight years. Not estranged — just diverged. Both of you moved and the geography solved itself.',
    ]),
    choices: null,
...

  {
    ...
    text: () => pick([
      'It took three hours, a recipe, and four failed attempts before it worked. The fourth time was the time. You know now what you had to fail at four times to know.',
      'Someone is asleep in the next room and their presence changes the silence. The silence with someone in it is different from the silence without.',
    ]),
    choices: null,
...

  {
    ...
    text: () => pick([
      'You held a job for two years that you do not think about much and that shaped what you know how to do. The shaping was invisible at the time.',
...

  {
    ...
    text: () => pick([
      'There are things you know you will never do. The list is not sad — it is clarifying. The energy that was spent on the possibility can now be spent on what is actually available.',
...

  {
    ...
    text: () => pick([
      'A long project has finally ended. You have been working on it for so long that the ending requires an adjustment. The time it occupied is now unoccupied. You will fill it with something.',
      'You were two people: the younger one and the older one. They are not continuous in every way. Some things were lost in the transition. Some things were gained. The balance is not precisely calculable.',
    ]),
    choices: null,
