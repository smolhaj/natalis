...
export const EVENTS_SONDER_12 = [
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.wentToSchool(G) && (G.age >= 40 && !G.mem?.s12SoundChildrenNearby),
...

  {
    ...
    phase: 'young_adult',
    weight: 2,
    when: (G) => place.isLiterate(G) && (G.age >= 18 && !G.mem?.s12OfficialForm),
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => place.hasTV(G) && (G.age >= 35 && !G.mem?.s12HourAfterDinner),
