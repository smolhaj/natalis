...

{
...

  {
    ...
    phase: 'midlife',
    weight: 2,
    when: (G) => G.age >= 40 && Object.values(G.parents ?? {}).some(par => par.alive) && !G.mem?.s14VisitRhythm,
...

{
...

  {
    ...
    text: (G) => `The woman across from you on the train today. She is doing something ordinary — ${G.currentYear >= 2005 ? 'reading, looking at her phone, looking at nothing in particular' : 'reading, looking out, looking at nothing in particular'} — and you observe, without meaning to, that she is at a specific moment in her life. You do not know what the moment is. But you can read the particular quality of attention she is giving to the nothing she is looking at — slightly inward, slightly away — and infer that something has recently happened, or is about to happen, or is being processed. You arrive at your stop and she continues.`,
    choices: null,
