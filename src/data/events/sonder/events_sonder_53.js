...
export const EVENTS_SONDER_53 = [
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53b,
    text: 'The piece of equipment you have used so long that its malfunction feels like an injury. Not expensive equipment necessarily. The specific chair, the specific knife, the specific pen, the drawer pull that is loose in a way you have learned to accommodate. Its absence or failure produces something disproportionate to its monetary value. The economy of objects: some of them accumulate significance far beyond their cost.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53c,
    text: 'The compliment you are still carrying years later. Not a compliment about your appearance or a flattering remark — a compliment that named something specific, that said I see this particular thing about you and it is good. You remember the room. You remember who said it and what they were wearing. The specific compliment did something to the person you were at the time and the doing is still present in the person you are now.',
    choices: null,
...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53k,
    text: 'The fear that was completely real to you and is completely mysterious to you now. Not embarrassing — genuinely mysterious: the thing you were afraid of that you cannot account for as an adult. The stairs, the sound, the shape behind the door. The fear had its own logic and the logic is no longer available. You remember the fear without remembering the reasoning that made it fear rather than just a thing.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53z,
    text: 'The flatmate who is now a stranger. You lived with this person in a state of intimate proximity for two years: you knew their sleeping schedule and their mood by the sound of the door and their grocery preferences and their way of leaving the kitchen. The intimacy was situational rather than chosen. The situation ended. The person you knew in that way is now someone you would nod at on the street. The intimacy was real and it was the intimacy of proximity, which is its own category.',
    choices: null,
