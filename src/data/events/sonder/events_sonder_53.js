...
export const EVENTS_SONDER_53 = [
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53b,
    text: 'You have used this tool so long that its malfunction feels like an injury. Not expensive equipment necessarily. The specific chair, the specific knife, the specific pen, the drawer pull that is loose in a way you have learned to accommodate. Its absence or failure produces something disproportionate to its monetary value. The economy of objects: some of them accumulate significance far beyond their cost.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53c,
    text: 'Years later you are still carrying a compliment. Not a compliment about your appearance or a flattering remark — a compliment that named something specific, that said I see this particular thing about you and it is good. You remember the room. You remember who said it and what they were wearing. The specific compliment did something to the person you were at the time and the doing is still present in the person you are now.',
    choices: null,
...

{
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53k,
    text: 'Something frightened you completely and is completely mysterious to you now. Not embarrassing — genuinely mysterious: the thing you were afraid of that you cannot account for as an adult. The stairs, the sound, the shape behind the door. The fear had its own logic and the logic is no longer available. You remember the fear without remembering the reasoning that made it fear rather than just a thing.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53q,
    text: 'A decision got made by not deciding. At some point the window for making the decision closed and the default — the staying, the not-moving, the continuing — became the choice. You did not choose the default. The default chose itself in the absence of a choice. Now the default is the condition and the condition is permanent enough that calling it a choice feels only partially wrong.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53t,
    text: 'There is a list now of things you can no longer eat. Not a list you made deliberately — the body made it over decades, through trial and error, through the specific conversations between your digestive system and various foods that produced specific outcomes. The list is now longer than it was at thirty. The body has opinions it did not have at thirty. The opinions are inconvenient and non-negotiable.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53u,
    text: 'You have told this joke too many times. You know you have told it too many times. The people around you are allowing you to tell it again. The dynamic in the room during the telling: the people who have heard it managing their response, the person who has not heard it laughing genuinely, the specific comedy of a joke that is most of the way to being a piece of family mythology rather than a joke. You tell it anyway. The ritual version of the funny thing is its own category of funny.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53z,
    text: 'Someone you once shared a kitchen with is now a stranger. You lived with this person in a state of intimate proximity for two years: you knew their sleeping schedule and their mood by the sound of the door and their grocery preferences and their way of leaving the kitchen. The intimacy was situational rather than chosen. The situation ended. The person you knew in that way is now someone you would nod at on the street. The intimacy was real and it was the intimacy of proximity, which is its own category.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53ab,
    text: 'You have walked this route often enough to walk it in the dark without thinking. The body navigates while the mind is elsewhere. You arrive and cannot quite account for the passage: the route happened beneath awareness, automatic, stored in the muscles rather than the conscious memory. The body has learned things the mind has not been told about.',
    choices: null,
...

  {
    ...
    weight: 2,
    when: (G) => !G.mem?.s53ad,
    text: 'A last time. You do not know it is the last time when it happens. The last time in the old apartment, the last time the whole family is in one room, the last time the conversation is easy in the way it was before a change that came later. The last time only becomes the last time retrospectively: at the time it was just that time, which is also every time. The knowledge arrives with the distance. The event itself contains no marker.',
    choices: null,
