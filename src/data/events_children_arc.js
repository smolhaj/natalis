    ...
    choices: [
      {
        ...
        effect: (p) => { p.m -= 12; p.r += 6; p.addFlag('child_estrangement'); p.setMem('childEstrangement', G.currentYear) },
      },
      {
        ...
        effect: (p) => { p.m -= 16; p.r += 9; p.addFlag('child_estrangement'); p.setMem('childEstrangement', G.currentYear) },
      },
    ],
    effect: null,
  },
