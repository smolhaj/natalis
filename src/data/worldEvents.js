...
export const WORLD_EVENTS = [
  ...
  {
    id: 'tajik_civil_war_1992',
    name: 'Tajikistan Civil War',
    years: [1992, 1997],
    archetypes: 'all',
    countries: ['Tajikistan'],
    narrative: 'The Soviet collapse triggers a civil war in Tajikistan. The old government backed by Russia and Uzbekistan fights Islamic opposition and regional warlords from Gharm and the Pamirs. Between 50,000 and 100,000 people are killed. One in ten Tajiks is displaced. Most of the educated professional class emigrates. The country will spend five years in this war before a peace agreement preserves the men who started it.',
    context: 'The Tajik civil war (1992–1997) was the deadliest post-Soviet conflict in Central Asia. It defied simple categorisation: while foreign observers described it as communist government vs. Islamist opposition, it was also a war of regional factions (Kulabi, Gharmis, Leninabadis, Pamiris) and of competing clan networks. Russia and Uzbekistan actively supported the Popular Front (government side). The United Tajik Opposition (UTO) was a coalition including the Islamic Renaissance Party, democrats, and nationalists. The 1997 General Agreement on the Establishment of Peace gave Emomali Rahmon the presidency and the UTO 30% of government posts. Rahmon subsequently consolidated complete power.',
    effect: (p) => { p.r += 10; p.m -= 8; p.h -= 6; p.addFlag('taj_civil_war_witness'); },
    addFlags: ['taj_civil_war_witness'],
    minAge: 5,
  },
  {
    id: 'osh_ethnic_violence_2010',
    name: 'Osh Ethnic Violence',
    years: [2010, 2011],
    archetypes: 'all',
    countries: ['Kyrgyzstan'],
    narrative: 'In June 2010, ethnic violence erupts in Osh and Jalal-Abad between Kyrgyz and Uzbeks. More than four hundred people are killed. Hundreds of thousands are displaced. Uzbek neighbourhoods are burned. Evidence of organised violence — trucks of armed men, address lists — suggests coordination. The interim government declares a state of emergency. The international response is slow.',
    context: 'The June 2010 Osh violence occurred weeks after President Bakiyev was overthrown in a second popular uprising. The causes were complex: political manipulation of ethnic tensions, local grievances, and the power vacuum created by Bakiyev\'s fall. The UN estimated 400,000 displaced; 400+ killed (contested). A Kyrgyz parliamentary commission and international human rights investigations found evidence of organised perpetration, though most perpetrators were never prosecuted. The Uzbek community of southern Kyrgyzstan lost property, lives, and some community members emigrated permanently.',
    effect: (p) => { p.r += 10; p.m -= 8; p.h -= 5; p.addFlag('kyr_osh_kyrgyz_witness'); },
    addFlags: ['kyr_osh_kyrgyz_witness'],
    minAge: 10,
    when: (G) => !G.flags.has('kyr_osh_uzbek_witness'),
  },
  {
    id: 'gbao_crackdown_2022',
    name: 'GBAO Security Crackdown',
    years: [2022, 2023],
    archetypes: 'all',
    countries: ['Tajikistan'],
    narrative: 'Protests in Gorno-Badakhshan following the killing of a local leader escalate into a government military operation in May 2022. Armoured vehicles move through mountain roads. The internet is cut. The number of dead is disputed; the government acknowledges deaths it does not enumerate. The GBAO crackdown is the largest security operation in the region since the civil war.',
    context: 'The protests in GBAO (Gorno-Badakhshan Autonomous Oblast) began in November 2021 after security forces killed Gulbiddin Ziyobekov, a local community figure. The region — home to the Pamiri people, mostly Ismaili Muslim, linguistically and culturally distinct from the Tajik majority — has a history of tension with the central government dating to the civil war. The 2022 operation, which involved the Tajik National Guard and special forces, was poorly documented due to internet blackouts. Human rights organisations reported dozens killed, hundreds arrested, and systematic torture in detention. International condemnation was limited.',
    effect: (p) => { p.r += 9; p.m -= 6; p.addFlag('taj_gbao_distant_witness'); },
    addFlags: ['taj_gbao_distant_witness'],
    minAge: 14,
    when: (G) => !G.flags.has('taj_gbao_witness'),
  },
  {
