    ...
    choices: [
      {
        ...
        effect: (p) => { p.m -= 10; p.mo -= 600; p.s += 4; p.addFlag('laid_off'); p.addFlag('redundancy_survivor') },
      },
      {
        ...
        effect: (p) => { p.m -= 6; p.mo -= 1200; p.r += 6; p.addFlag('laid_off'); p.addFlag('redundancy_survivor') },
      },
    ],
    effect: null,
  },
