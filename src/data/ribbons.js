export const RIBBONS = [
  ...
  },
  {
    ...
    condition: (G) => G.flags.includes('khmer_rouge_rural_witness') || G.flags.includes('family_taken_khmer_rouge') || G.flags.includes('phnom_penh_return') || G.flags.includes('landmine_country'),
    priority: 95,
    color: 'purple',
  },
  {
  ...
  },
  {
    ...
    condition: (G) => G.flags.includes('rust_belt_generation'),
    priority: 70,
    color: 'gray',
  },
  {
    ...
    condition: (G) => G.flags.includes('red_scare_generation') && G.flags.includes('defied_authority'),
    priority: 82,
    color: 'blue',
  },
  {
  ...
  },
  {
    ...
    condition: (G) => G.flags.includes('in_recovery') && !G.flags.includes('relapsed') && G.age >= 35,
    priority: 78,
    color: 'blue',
  },
  {
  ...
  },
  {
    ...
    condition: (G) => G.flags.includes('deaf_identity') || G.flags.includes('deaf_community_identity') || G.flags.includes('deaf_community_found'),
    priority: 70,
    color: 'blue',
  },
  {
