...
**PRs #90–92** (MODE A/B/C continuing rotation): **PR #90** documentation-only (updated state docs to reflect PRs #73–89). **PR #91** MODE B/C pass + three depth arcs: Mode C polish closing 23 partial flags and filling career/mental-health texture gaps; Syria arc (events_syria.js, 8 events: Ba'ath childhood, Hama 1982, Damascus Spring 2000–01 with 2-choice fork, March 2011 uprising with 3 paths, checkpoint daily life 2012–19, displacement decision, Europe arrival, late-life reckoning for those who stayed); child death arc (events_child_death_arc.js, 11 events: infant death trigger archetype×era-probabilistic, first weeks objects/room, telling new people, room decision, try again 3-choice, surviving siblings, anniversary, cohort flash in others, marriage reflection, late reckoning "who they would have been," the unsaid thing); Israel arc with new countries.js entry (events_israel.js, 13 events: founding memory, Mizrahi ma'abara 1949–72, IDF mandatory service, Yom Kippur War 1973, Soviet aliyah 1990s, Ethiopian aliyah Operations Moses/Solomon, Rabin assassination 1995, second intifada civilian 2001–05, settlement choice, Arab citizen divided identity, Oct 7 2023, post-Oslo despair); China depth +10 events to events_china.js (Great Leap famine, struggle sessions target/witness, hukou barrier, reform euphoria, 996 burnout, leftover woman pressure, Hui Muslim identity, Xi-era tightening, sent-down intellectual echo); Palestine depth +6 events to events_palestine.js (refugee camp generations, olive harvest, administrative detention, water rationing, Gaza bombardment, late return question); Philippines domestic arc (events_philippines.js, 9 events: Marcos 1081, Aquino assassination, EDSA 1986, post-EDSA disillusionment, typhoon season, Haiyan 2013, dynasty texture, Duterte drug war, Marcos Jr 2022); Greece/Portugal arc (events_greece_portugal.js, 11 events: Greek junta announcement, cultural ban, Polytechnic uprising 1973, junta fall 1974 + Carnation Revolution Portugal, transition period); India depth arc (events_india_depth.js, 11 events: arranged marriage meetings, joint family entry, English-medium identity conflict, CAA protests 2019, farmers' protests); Spain arc (events_spain.js, 11 events: Franco school, Basque language suppressed, Catalan suppressed, transition to democracy, ETA moral question); pandemic arc (events_pandemic.js, 16 events: healthcare worker arc, informal economy lockdown, remote work divide, vaccine access by archetype, long COVID, pandemic grief). 36 new flags registered, 11+ new ribbons. **PR #92** massive MODE A geographic expansion — 38+ new country arc modules, 9 new followthrough modules: events_usa.js (12 events: Jim Crow childhood, Great Migration, civil rights movement, Vietnam draft, Rust Belt deindustrialisation, AIDS crisis LGBTQ); events_uk.js (7 events: miners' strike 1984, poll tax riots 1990, Iraq War 2003, Brexit texture, Grenfell Tower, Windrush scandal, austerity decade); events_germany_france.js (9 events: Gastarbeiter arrival, Turkish-German identity, DDR daily life, Berlin Wall fall, reunification); events_australia.js (8 events: White Australia policy, Vietnam conscription, Whitlam dismissal 1975, Port Arthur massacre 1996); events_italy.js (8 events: economic miracle 1950s–60s, southern emigration, 1968 hot autumn, Years of Lead, Berlusconi); events_canada.js (8 events: October Crisis 1970, Charter of Rights 1982, Meech Lake, Quebec referendum 1995); events_poland.js (7 events: communist childhood, John Paul II election 1978, Solidarity 1980, martial law 1981, transition); events_japan.js (12 events: postwar childhood, Anpo protests 1960, economic miracle, company housing, Lost Generation, hikikomori, Fukushima 2011); events_brazil.js (9 events: favela childhood, AI-5 dictatorship, Tropicália coded resistance, amnesty 1979, Diretas Já 1984); events_russia.js (4 core + depth: Afghan war veteran, Beslan 2004, Bolotnaya protests, Navalny + Chechnya wars + Ukraine 2022 mobilisation draft); events_ukraine.js (7 events: Holodomor family memory, independence 1991, language question, Orange Revolution, Maidan 2014, 2022 invasion, displacement); events_romania.js (5 events: Securitate childhood, Decree 779 forced childbirth, December revolution 1989, transition); events_south_africa.js (4 events: Soweto uprising 1976, Mandela release 1990, #FeesMustFall, state capture); events_central_europe.js (9 events: Hungarian 1956 uprising child/adult perspectives, Kádár goulash socialism, Dubček Prague Spring 1968, border opening 1989, Czech Velvet Revolution); events_baltic.js (6 events: deportation family memory, Soviet school, Song Festival resistance, January 1991 independence barricades); events_taiwan_malaysia.js (9 events: 228 massacre 1947, White Terror waishengren identity, Taiwan democratisation + Malaysian NEP, Malay-Chinese ethnic divide, Reformasi); events_georgia.js (10 events: April 9 1989 massacre, Abkhazia war 1992–93, Rose Revolution 2003, August 2008 Russian war, EU aspiration, supra table culture, Orthodox identity); events_armenia_azerbaijan.js (15 events: genocide family oral memory, 1988 earthquake, Baku pogrom 1990, dark winter 1992–94, first Karabakh war, 2020 war, diaspora); events_belarus.js (8 events: partisan republic memory, Chernobyl shadow, Lukashenko election 1994, technocratic authoritarian texture, 2020 stolen election, protest crackdown); events_north_korea.js (9 events: Juche childhood, songbun class system, public criticism session, famine 1990s two paths, defection decision Tumen River crossing); events_uy_py_ec.js (13 events: Uruguay Tupamaros guerrilla/coup/Bordaberry dictatorship; Paraguay Stroessner's 35-year authoritarian stability; Ecuador indigenous CONAIE land rights, Amazonian oil) — 3 countries added (Uruguay, Paraguay, Ecuador); events_cuba.js (8 events: revolution childhood, Bay of Pigs, Mariel 1980, Santería underground, Special Period cycling/libreta, balsero decision, Timba Havana, post-Raúl); events_namibia.js (8 events: Herero oral history of genocide, communal land post-independence, contract labour apartheid legacy, AIDS generation, SWAPO era); events_laos.js (7 events: UXO childhood normalised, alms round Buddhist texture, Hmong highland persecution, Secret War US bombing, Pathet Lao 1975, refugee Mekong crossing); events_singapore.js (8 events: separation from Malaysia 1965, kampung clearing/HDB resettlement, Speak Mandarin campaign, PAP one-party stability, Lee Kuan Yew death 2015); events_netherlands.js (8 events: Hunger Winter 1944–45 family memory, verzuiling pillarisation, Provo youth movement 1965, Srebrenica Dutch battalion, Islamophobia Fortuyn); events_bangladesh.js (9 events: Bhola cyclone shadow, Liberation War 1971, 1974 famine, Mujib assassination 1975, garment industry female worker, Rana Plaza 2013, Shahbag 2013, Rohingya cross-border witness); events_iraq.js (8 events: Ba'ath childhood privilege, Iran-Iraq war conscription, sanctions 1990s pharmacy shelves, 2003 invasion, sectarian violence, ISIS 2014, reconstruction ambiguity); events_rwanda.js (8 events: Habyarimana childhood, Radio Mille Collines crescendo, hundred days adolescent/adult witness, survivor's return, gacaca community court, intergenerational wound 30 years on); events_colombia.js (9 events: Bogotazo 1948, la Violencia rural flight, FARC question young adult, Medellín cartel neighbourhood texture, paramilitary AUC, peace process 2016, post-accords implementation); events_venezuela.js (8 events: Chávez election 1998, 2002 coup attempt, oil misiones, PSUV membership, shortage textures, 2014–19 exodus, diaspora obligation); events_peru.js (8 events: Sendero Luminoso childhood, Fujimori autogolpe 1992, forced sterilisation programme, CVR truth commission, Toledo/Humala/Castillo instability); events_saudi.js (9 events: Aramco generation 1950s, Grand Mosque siege 1979, mutaween street enforcement, Gulf War 1990, 9/11 aftermath for Saudis, Vision 2030 social liberalisation); events_iran.js (7 events: Khatami reform era, sanctions economy double life, hijab enforcement texture, brain drain decision, JCPOA hope 2015, Mahsa Amini 2022 protests). Depth passes on existing modules: Argentina 2001 collapse (5 events added), Mexico Ayotzinapa/2017 earthquake (added), South Africa #EndSARS/post-1994 texture (added), Russia Chechnya/Ukraine 2022 draft (added), Pakistan Bhutto/APS attack/blasphemy law (added), India CAA/farmers protests (added), Japan Lost Generation/hikikomori/Fukushima depth (added). Mode B: events_desire_resolution.js (8 events: positive arc for all 8 core desires — desire successfully met in late life, not just unfulfilled); leaningWeight system (political_leaning now provides 1.3–1.5× weight boost to matching events). events_followthrough_14 (13 events: USA/Australia/Poland/Italy arc follow-throughs) + events_followthrough_15 (14 events: Japan arc + Latin America late-life follow-throughs) + events_followthrough_16 through followthrough_22 (42 total events covering newly-orphaned flags from all new arcs). 98 countries total, 223 world events, 218+ event modules, ~4,200+ events, 1,232 registered flags, 311 ribbons.*
...
- **Syria** ✅ DONE (PR #91, events_syria.js): Ba'ath childhood, Hama 1982, Damascus Spring 2000–01, March 2011 uprising (3 choices), checkpoint 2012–19, displacement decision, Europe arrival, late reckoning.
...
**Death of a child arc** ✅ DONE (PR #91, events_child_death_arc.js): 11 events — infant death trigger archetype×era-probabilistic, first weeks objects/room prose, telling new people, room decision (keep/change), try again 3-choice, surviving siblings, anniversary, cohort flash (seeing them in others), marriage reflection, late reckoning "who they would have been," the unsaid thing.
...
**FURTHER EXPANDED ✅ (PRs #91–92)**: Israel arc (events_israel.js, 13 events), China +10 events, Palestine +6 events (PR #91). Philippines arc (events_philippines.js, 9 events), Greece/Portugal arc (events_greece_portugal.js, 11 events), India depth arc (events_india_depth.js, 11 events), Spain arc (events_spain.js, 11 events), USA arc (events_usa.js, 12 events), UK arc (events_uk.js, 7 events), Germany/France arc (events_germany_france.js, 9 events), Australia arc (events_australia.js, 8 events), Italy arc (events_italy.js, 8 events), Canada arc (events_canada.js, 8 events), Poland arc (events_poland.js, 7 events), Japan arc (events_japan.js, 12 events), Brazil arc (events_brazil.js, 9 events), Russia arc (events_russia.js, 4 events + depth), Ukraine arc (events_ukraine.js, 7 events), Romania arc (events_romania.js, 5 events), South Africa depth (events_south_africa.js, 4 events), Hungary/Czech arc (events_central_europe.js, 9 events), Baltic arc (events_baltic.js, 6 events), Taiwan/Malaysia arc (events_taiwan_malaysia.js, 9 events), Georgia arc (events_georgia.js, 10 events), Armenia/Azerbaijan arc (events_armenia_azerbaijan.js, 15 events), Belarus arc (events_belarus.js, 8 events), North Korea arc (events_north_korea.js, 9 events), Uruguay/Paraguay/Ecuador arc (events_uy_py_ec.js, 13 events), Cuba depth arc (events_cuba.js, 8 events), Namibia arc (events_namibia.js, 8 events), Laos arc (events_laos.js, 7 events), Singapore arc (events_singapore.js, 8 events), Netherlands arc (events_netherlands.js, 8 events), Bangladesh arc (events_bangladesh.js, 9 events), Iraq arc (events_iraq.js, 8 events), Rwanda arc (events_rwanda.js, 8 events), Colombia arc (events_colombia.js, 9 events), Venezuela arc (events_venezuela.js, 8 events), Peru arc (events_peru.js, 8 events), Saudi Arabia arc (events_saudi.js, 9 events), Iran depth arc (events_iran.js, 7 events) (all PR #92).
...
**Cuba** ✅ DONE (PRs #48 + #92): Character events in events_latin_america.js (CDR, Special Period, balseros) expanded with full events_cuba.js (8 events, PR #92): revolution childhood, Bay of Pigs, Mariel 1980, Santería underground, Special Period cycling/libreta, balsero decision, Timba Havana, post-Raúl opening.
...
**Southeast Asia** ✅ DONE (PRs #73–89 + #92): Thailand arc (events_thailand.js, 6 events). Myanmar arc (events_myanmar.js, 7 events). Philippines arc (events_philippines.js, 9 events: Marcos martial law, Aquino assassination, EDSA 1986, Haiyan, Duterte drug war, Marcos Jr — PR #91). Malaysia arc (events_taiwan_malaysia.js: Malaysian NEP, Malay-Chinese ethnic divide, Reformasi — PR #92). Vietnam Doi Moi + boat people in events_vietnam.js.

**Southeast Europe** ✅ DONE (PRs #73–89 + #92): `events_southeast_europe.js` (9 events — Yugoslav collapse, Bosnian War/Srebrenica, Kosovo, ICTY). Greece military junta (1967–74) in events_greece_portugal.js (PR #91). Romania Ceaușescu arc in events_romania.js (PR #92). Basque ETA in events_spain.js (PR #91).
...
- **COVID-19 from inside a lockdown** ✅ DONE (PR #91, events_pandemic.js): 16 events — healthcare worker arc (PPE rationing, moral injury), informal economy lockdown (no work, no savings), remote work as class privilege, vaccine access by archetype, long COVID, pandemic grief. Archetype-branched for wealthy_west / developing_urban / subsaharan / conflict_zone. Follows the spec: Milan overwhelmed, Lagos informal economy zero income, healthcare worker texture. 2020–2023 era-gated.
...
- **McCarthyism** (USA 1950–54): ✅ DONE in events_usa.js (PR #92) — loyalty investigation texture, subpoena, "Are you now or have you ever been," the naming names vs. refusing fork.
- **West German Ostpolitik / Gastarbeiter**: ✅ DONE in events_germany_france.js (PR #92) — Gastarbeiter arrival, Turkish-German identity, DDR daily life, reunification 1990.
- **Northern Ireland's Troubles** (both perspectives): ✅ DONE in events_ireland_turkey.js (PRs #73–89) — Troubles texture, both communities.
- **Basque ETA in Spain** (1960s–2011): ✅ DONE in events_spain.js (PR #91) — Basque language suppressed under Franco, ETA emergence, moral question post-democracy, peace process.
...
**North Korea** ✅ DONE (PR #92, events_north_korea.js): 9 events — Juche childhood indoctrination, songbun class system limiting life choices, public criticism session, famine 1990s two paths (survive/don't), defection decision arc (Tumen River crossing, broker network, China dangers). Carefully gated: full Juche/songbun interior arc fires broadly; defection path requires accumulated flags.
...
- The White Australia policy ✅ DONE in events_australia.js (PR #92): dictation test, Vietnam conscription, Whitlam dismissal, Port Arthur.
- New Zealand nuclear-free policy 1984: not yet implemented. A character in Wellington in 1985 when the US frigate is refused port and the ANZUS alliance fractures.
